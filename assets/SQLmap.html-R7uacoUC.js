import{_ as i}from"./plugin-vue_export-helper-x3n3nnut.js";import{r as d,o as a,c as l,a as e,d as t,e as n}from"./app-AbhabbHp.js";const r="/assets/SQLmap-mHw05ZgF.png",c={},o=n('<h1 id="sqlmap使用手册小结" tabindex="-1"><a class="header-anchor" href="#sqlmap使用手册小结" aria-hidden="true">#</a> SQLmap使用手册小结</h1><figure><img src="'+r+`" alt="SQLmap" tabindex="0" loading="lazy"><figcaption>SQLmap</figcaption></figure><h2 id="_1-基本操作笔记" tabindex="-1"><a class="header-anchor" href="#_1-基本操作笔记" aria-hidden="true">#</a> 1. 基本操作笔记</h2><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>
-u  #注入点 
-f  #指纹判别数据库类型 
-b  #获取数据库版本信息 
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>参考资料：</p><p>sqlmap用户手册中文版：https://octobug.gitbooks.io/sqlmap-wiki-zhcn/content/Users-manual/Introduction.html</p><p>sqlmap用户手册：http://drops.xmd5.com/static/drops/tips-143.html</p>`,194);function b(g,x){const s=d("ExternalLinkIcon");return a(),l("div",null,[o,e("figure",null,[e("a",u,[v,t(s)]),p]),m])}const L=i(c,[["render",b],["__file","SQLmap.html.vue"]]);export{L as default};
