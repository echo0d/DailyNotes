import{_ as n}from"./plugin-vue_export-helper-x3n3nnut.js";import{o as e,c as i,e as a}from"./app-dKqLBwmz.js";const s="/DailyNotes/assets/image-20240320220720825-g-gFw9qm.png",l="/DailyNotes/assets/image-20240323122637144-xxemv3Yf.png",d="/DailyNotes/assets/image-20240323124302842-gxjfEE33.png",o="/DailyNotes/assets/image-20240323175325426-oPlYRI5Z.png",r="/DailyNotes/assets/image-20240323180618198-9KdCVqb0.png",c="/DailyNotes/assets/image-20240323180830536-NsRRtemS.png",t={},u=a(`<h1 id="_2-程序结构" tabindex="-1"><a class="header-anchor" href="#_2-程序结构" aria-hidden="true">#</a> 2. 程序结构</h1><h2 id="_2-1-命名" tabindex="-1"><a class="header-anchor" href="#_2-1-命名" aria-hidden="true">#</a> 2.1. 命名</h2><h3 id="关键字" tabindex="-1"><a class="header-anchor" href="#关键字" aria-hidden="true">#</a> 关键字</h3><p>Go语言中类似if和switch的关键字有25个；关键字不能用于自定义名字，只能在特定语法结构中使用。</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>break      default       func     interface   select
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><figure><img src="`+s+`" alt="image-20240320220720825" tabindex="0" loading="lazy"><figcaption>image-20240320220720825</figcaption></figure><p>因为指针包含了一个变量的地址，因此如果将指针作为参数调用函数，那将可以在函数中通过该指针来更新变量的值。例如下面</p><div class="language-Go line-numbers-mode" data-ext="Go"><pre class="language-Go"><code>func incr(p *int) int {
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><figure><img src="`+c+'" alt="image-20240323180830536" tabindex="0" loading="lazy"><figcaption>image-20240323180830536</figcaption></figure>',169),v=[u];function p(m,b){return e(),i("div",null,v)}const h=n(t,[["render",p],["__file","ch2.html.vue"]]);export{h as default};
