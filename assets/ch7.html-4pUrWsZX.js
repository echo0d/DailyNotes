import{_ as s}from"./plugin-vue_export-helper-DlAUqK2U.js";import{c as a,b as t,o as p}from"./app-BolV5aXk.js";const o={};function e(c,n){return p(),a("div",null,n[0]||(n[0]=[t(`<h1 id="_07-go语言-接口" tabindex="-1"><a class="header-anchor" href="#_07-go语言-接口"><span>07. GO语言-接口</span></a></h1><h2 id="_7-1-接口是合约" tabindex="-1"><a class="header-anchor" href="#_7-1-接口是合约"><span>7.1. 接口是合约</span></a></h2><p>Go 语言中的接口是一种抽象类型，它定义了一组方法。任何类型只要实现了接口定义的所有方法，就称之为实现了该接口。接口可以用于定义行为的规范，从而实现代码的解耦和复用。</p><p><strong>接口是合约</strong>的意思是指，接口定义了一组方法的规范，就像一份合约一样，规定了某些类型必须遵守的行为。任何类型只要实现了接口定义的所有方法，就相当于签署了这份合约，承诺会遵守约定的行为。</p><p>在 Go 语言中，接口（interface）是一种类型，用于定义方法集合。通过接口，你可以定义一组方法的契约，并使不同的类型实现这些方法，从而实现多态性。</p><p>下面是一个使用接口的简单示例：</p><pre><code class="language-go"><span class="token keyword">package</span> main
...
</code></pre>`,39)]))}const i=s(o,[["render",e]]),k=JSON.parse('{"path":"/develop/Go/gopl/ch7.html","title":"07. GO语言-接口","lang":"zh-CN","frontmatter":{"category":"Go","tag":"Go","description":"07. GO语言-接口 7.1. 接口是合约 Go 语言中的接口是一种抽象类型，它定义了一组方法。任何类型只要实现了接口定义的所有方法，就称之为实现了该接口。接口可以用于定义行为的规范，从而实现代码的解耦和复用。 接口是合约的意思是指，接口定义了一组方法的规范，就像一份合约一样，规定了某些类型必须遵守的行为。任何类型只要实现了接口定义的所有方法，就相当...","head":[["meta",{"property":"og:url","content":"https://echo0d.github.io/DailyNotes/develop/Go/gopl/ch7.html"}],["meta",{"property":"og:site_name","content":"echo0d-notes"}],["meta",{"property":"og:title","content":"07. GO语言-接口"}],["meta",{"property":"og:description","content":"07. GO语言-接口 7.1. 接口是合约 Go 语言中的接口是一种抽象类型，它定义了一组方法。任何类型只要实现了接口定义的所有方法，就称之为实现了该接口。接口可以用于定义行为的规范，从而实现代码的解耦和复用。 接口是合约的意思是指，接口定义了一组方法的规范，就像一份合约一样，规定了某些类型必须遵守的行为。任何类型只要实现了接口定义的所有方法，就相当..."}],["meta",{"property":"og:type","content":"article"}],["meta",{"property":"og:locale","content":"zh-CN"}],["meta",{"property":"og:updated_time","content":"2025-04-11T02:11:10.000Z"}],["meta",{"property":"article:author","content":"echo0d"}],["meta",{"property":"article:tag","content":"Go"}],["meta",{"property":"article:modified_time","content":"2025-04-11T02:11:10.000Z"}],["script",{"type":"application/ld+json"},"{\\"@context\\":\\"https://schema.org\\",\\"@type\\":\\"Article\\",\\"headline\\":\\"07. GO语言-接口\\",\\"image\\":[\\"\\"],\\"dateModified\\":\\"2025-04-11T02:11:10.000Z\\",\\"author\\":[{\\"@type\\":\\"Person\\",\\"name\\":\\"echo0d\\",\\"url\\":\\"\\"}]}"]]},"headers":[{"level":2,"title":"7.1. 接口是合约","slug":"_7-1-接口是合约","link":"#_7-1-接口是合约","children":[{"level":3,"title":"练习 7.1","slug":"练习-7-1","link":"#练习-7-1","children":[]},{"level":3,"title":"练习 7.2","slug":"练习-7-2","link":"#练习-7-2","children":[]},{"level":3,"title":"练习 7.3","slug":"练习-7-3","link":"#练习-7-3","children":[]}]},{"level":2,"title":"7.2. 接口类型","slug":"_7-2-接口类型","link":"#_7-2-接口类型","children":[{"level":3,"title":"练习 7.4","slug":"练习-7-4","link":"#练习-7-4","children":[]}]}],"git":{"createdTime":1722415943000,"updatedTime":1744337470000,"contributors":[{"name":"echo0d","email":"echo0d@163.com","commits":3}]},"readingTime":{"minutes":5.73,"words":1720},"filePathRelative":"develop/Go/gopl/ch7.md","localizedDate":"2024年7月31日","excerpt":"\\n<h2>7.1. 接口是合约</h2>\\n<p>Go 语言中的接口是一种抽象类型，它定义了一组方法。任何类型只要实现了接口定义的所有方法，就称之为实现了该接口。接口可以用于定义行为的规范，从而实现代码的解耦和复用。</p>\\n<p><strong>接口是合约</strong>的意思是指，接口定义了一组方法的规范，就像一份合约一样，规定了某些类型必须遵守的行为。任何类型只要实现了接口定义的所有方法，就相当于签署了这份合约，承诺会遵守约定的行为。</p>\\n<p>在 Go 语言中，接口（interface）是一种类型，用于定义方法集合。通过接口，你可以定义一组方法的契约，并使不同的类型实现这些方法，从而实现多态性。</p>","autoDesc":true}');export{i as comp,k as data};
