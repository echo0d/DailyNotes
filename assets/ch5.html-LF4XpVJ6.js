import{_ as n}from"./plugin-vue_export-helper-x3n3nnut.js";import{o as s,c as i,e}from"./app-M_dl_1Wq.js";const a="/DailyNotes/assets/1714383289597-b8d4cdf7-f5a3-49d2-8dd8-652490885b88-Odj_dT_N.png",t="/DailyNotes/assets/1714442560647-cbfe178e-6257-4d03-97d4-e029c6da023d-kwPEAa6C.png",l="/DailyNotes/assets/1714443651003-976fdbac-2e4a-43e8-8353-2d85c01a6952-xhpULx3O.png",d="/DailyNotes/assets/1714444173757-c513c000-88fe-4f7b-888a-17259191a862-L874tiBz.png",r="/DailyNotes/assets/1714459827460-45563e29-cc6b-4ab7-8dff-8a09f4922f4a-FeFmKpGf.png",u="/DailyNotes/assets/1714462376419-a66dbfc9-1ccf-4a46-bd1e-c4e321db2231-EbVkA2Hb.png",c="/DailyNotes/assets/1714468666342-34d43878-7ef2-48f5-8c13-e42a0fce67f7-ZGmzv4Wi.png",o={},v=e(`<h1 id="_5-函数" tabindex="-1"><a class="header-anchor" href="#_5-函数" aria-hidden="true">#</a> 5. 函数</h1><h2 id="_5-1-函数声明" tabindex="-1"><a class="header-anchor" href="#_5-1-函数声明" aria-hidden="true">#</a> 5.1. 函数声明</h2><p>函数声明包括函数名、形式参数列表、返回值列表（可省略）以及函数体。</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code> func name(parameter-list) (result-list) {
     body
 }
