import{_ as n}from"./plugin-vue_export-helper-x3n3nnut.js";import{o as i,c as s,e}from"./app-dMCn0zhu.js";const a="/DailyNotes/assets/1714383289597-b8d4cdf7-f5a3-49d2-8dd8-652490885b88-Odj_dT_N.png",l="/DailyNotes/assets/1714442560647-cbfe178e-6257-4d03-97d4-e029c6da023d-kwPEAa6C.png",t="/DailyNotes/assets/1714443651003-976fdbac-2e4a-43e8-8353-2d85c01a6952-xhpULx3O.png",d="/DailyNotes/assets/1714444173757-c513c000-88fe-4f7b-888a-17259191a862-L874tiBz.png",r="/DailyNotes/assets/1714459827460-45563e29-cc6b-4ab7-8dff-8a09f4922f4a-FeFmKpGf.png",u="/DailyNotes/assets/1714462376419-a66dbfc9-1ccf-4a46-bd1e-c4e321db2231-EbVkA2Hb.png",c="/DailyNotes/assets/1714468666342-34d43878-7ef2-48f5-8c13-e42a0fce67f7-ZGmzv4Wi.png",v={},o=e(`<h1 id="_5-复合数据类型" tabindex="-1"><a class="header-anchor" href="#_5-复合数据类型" aria-hidden="true">#</a> 5. 复合数据类型</h1><h2 id="_5-1-函数声明" tabindex="-1"><a class="header-anchor" href="#_5-1-函数声明" aria-hidden="true">#</a> 5.1. 函数声明</h2><p>函数声明包括函数名、形式参数列表、返回值列表（可省略）以及函数体。</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code> func name(parameter-list) (result-list) {
     body
 }
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><figure><img src="`+t+`" alt="image.png" tabindex="0" loading="lazy"><figcaption>image.png</figcaption></figure><h3 id="练习-5-2" tabindex="-1"><a class="header-anchor" href="#练习-5-2" aria-hidden="true">#</a> 练习 5.2</h3><p>编写函数，记录在HTML树中出现的同名元素的次数。</p><div class="language-go line-numbers-mode" data-ext="go"><pre class="language-go"><code> <span class="token keyword">package</span> main
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="练习5-10" tabindex="-1"><a class="header-anchor" href="#练习5-10" aria-hidden="true">#</a> 练习5.10</h3><p>重写topoSort函数，用map代替切片并移除对key的排序代码。验证结果的正确性（结果不唯一）。</p><p><strong>练习5.11：</strong> 现在线性代数的老师把微积分设为了前置课程。完善topSort，使其能检测有向图中的环。</p><p><strong>练习5.12：</strong> ch5/outline2（5.5节）的startElement和endElement共用了全局变量depth，将它们修改为匿名函数，使其共享outline中的局部变量。</p><p><strong>练习5.13：</strong> 修改crawl，使其能保存发现的页面，必要时，可以创建目录来保存这些页面。只保存来自原始域名下的页面。假设初始页面在golang.org下，就不要保存vimeo.com下的页面。</p><p><strong>练习5.14：</strong> 使用breadthFirst遍历其他数据结构。比如，topoSort例子中的课程依赖关系（有向图）、个人计算机的文件层次结构（树）；你所在城市的公交或地铁线路（无向图）。</p>`,132),p=[o];function m(b,g){return i(),s("div",null,p)}const h=n(v,[["render",m],["__file","ch5.html.vue"]]);export{h as default};
