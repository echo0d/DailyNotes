import{_ as n}from"./plugin-vue_export-helper-x3n3nnut.js";import{o as e,c as i,e as s}from"./app-XsN45Fjb.js";const a="/DailyNotes/assets/image-20240320220720825-g-gFw9qm.png",l="/DailyNotes/assets/image-20240323122637144-xxemv3Yf.png",d="/DailyNotes/assets/image-20240323124302842-gxjfEE33.png",t="/DailyNotes/assets/image-20240323175325426-oPlYRI5Z.png",r="/DailyNotes/assets/image-20240323180618198-9KdCVqb0.png",o="/DailyNotes/assets/image-20240323180830536-NsRRtemS.png",c="/DailyNotes/assets/image-20240324214859220-F8ts3tCu.png",u="/DailyNotes/assets/image-20240324221637025-tQ513VgR.png",v="/DailyNotes/assets/image-20240325113004910-MIVA9D6C.png",p={},m=s(`<h1 id="_2-程序结构" tabindex="-1"><a class="header-anchor" href="#_2-程序结构" aria-hidden="true">#</a> 2. 程序结构</h1><h2 id="_2-1-命名" tabindex="-1"><a class="header-anchor" href="#_2-1-命名" aria-hidden="true">#</a> 2.1. 命名</h2><h3 id="关键字" tabindex="-1"><a class="header-anchor" href="#关键字" aria-hidden="true">#</a> 关键字</h3><p>Go语言中类似if和switch的关键字有25个；关键字不能用于自定义名字，只能在特定语法结构中使用。</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>break      default       func     interface   select
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>在每个源文件的包声明前的注释是包注释（§10.7.4）。通常，包注释的第一句应该先是包的功能概要说明。一个包通常只有一个源文件有包注释（译注：如果有多个包注释，目前的文档工具会根据源文件名的先后顺序将它们链接为一个包注释）。如果包注释很大，通常会放到一个独立的doc.go文件中。</p><p><strong>练习 2.1：</strong> 向tempconv包添加类型、常量和函数用来处理Kelvin绝对温度的转换，Kelvin 绝对零度是−273.15°C，Kelvin绝对温度1K和摄氏度1°C的单位间隔是一样的。</p><div class="language-go line-numbers-mode" data-ext="go"><pre class="language-go"><code><span class="token comment">// Package tempconv performs Celsius and Fahrenheit conversions.</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div>`,218),b=[m];function g(f,h){return e(),i("div",null,b)}const q=n(p,[["render",g],["__file","ch2.html.vue"]]);export{q as default};
