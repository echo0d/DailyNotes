import{_ as e}from"./plugin-vue_export-helper-x3n3nnut.js";import{o as n,c as s,e as a}from"./app-ywYBuvLZ.js";const i={},d=a(`<h1 id="go语言-helloworld" tabindex="-1"><a class="header-anchor" href="#go语言-helloworld" aria-hidden="true">#</a> Go语言-HelloWorld</h1><h2 id="_1、go基础" tabindex="-1"><a class="header-anchor" href="#_1、go基础" aria-hidden="true">#</a> 1、Go基础</h2><h3 id="_1-1-goproxy设置" tabindex="-1"><a class="header-anchor" href="#_1-1-goproxy设置" aria-hidden="true">#</a> 1.1 GOPROXY设置</h3><p>windows下载安装包，直接默认安装。此处版本go1.15.15</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>PS C:\\Users\\echo0d\\Desktop\\gopl.io-master\\ch1\\helloworld&gt; go env
set GO111MODULE=on
set GOARCH=amd64                                  
set GOBIN=                                        
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>除此之外还有</p><p>七牛云：https://goproxy.cn</p><p>aliyun：https://mirrors.aliyun.com/goproxy/</p><h3 id="_1-2-hello-world" tabindex="-1"><a class="header-anchor" href="#_1-2-hello-world" aria-hidden="true">#</a> 1.2 Hello, World</h3><p>示例代码<em>gopl.io/ch1/helloworld</em></p><div class="language-go line-numbers-mode" data-ext="go"><pre class="language-go"><code><span class="token keyword">package</span> main
