import{_ as s}from"./plugin-vue_export-helper-DlAUqK2U.js";import{c as a,b as t,o as p}from"./app-CV56mcHb.js";const o="/DailyNotes/assets/1712132982776-Dmw0_-7i.png",c="/DailyNotes/assets/image-20240409145949392-vfUSVDmj.png",e="/DailyNotes/assets/20240411-BEZOW4xT.png",u="/DailyNotes/assets/1712825319476-CT_reDXN.png",l="/DailyNotes/assets/image-20240411172248377-CglDSDn3.png",k="/DailyNotes/assets/image-20240415134037655-BsOJy7P0.png",i="/DailyNotes/assets/image-20240415143331842-D6WNZpDo.png",r="/DailyNotes/assets/image-20240415153834143-BWR2ftVy.png",m="/DailyNotes/assets/image-20240415153609218-B9PslcWj.png",d="/DailyNotes/assets/image-20240416134123069-D0VOHaWH.png",f="/DailyNotes/assets/image-20240416134927313-BYe2doYg.png",g="/DailyNotes/assets/ch3-04-fSxxl3FU.png",b="/DailyNotes/assets/image-20240416140122874-DcxBhIWS.png",y="/DailyNotes/assets/image-20240416143310476-BtSI1iZy.png",h="/DailyNotes/assets/image-20240416144001322-BBkcl6P3.png",x="/DailyNotes/assets/image-20240416144219458-D-TDq4na.png",q="/DailyNotes/assets/image-20240416144615253-D-uuoqZL.png",w="/DailyNotes/assets/ch3-05-BNk_jxfa.png",v="/DailyNotes/assets/image-20240416152614804-sWwgBELs.png",G={};function R(z,n){return p(),a("div",null,n[0]||(n[0]=[t(`<h1 id="_03-基础数据类型" tabindex="-1"><a class="header-anchor" href="#_03-基础数据类型"><span>03. 基础数据类型</span></a></h1><p>Go语言将数据类型分为四类：基础类型、复合类型、引用类型和接口类型。</p><ul><li>本章介绍基础类型，包括：数字、字符串和布尔型。</li><li>复合数据类型——数组（§4.1）和结构体（§4.2）——是通过组合简单类型，来表达更加复杂的数据结构。</li><li>引用类型包括指针（§2.3.2）、切片（§4.2)）、字典（§4.3）、函数（§5）、通道（§8）</li><li>将在第7章介绍接口类型</li></ul><p>虽然数据种类很多，但它们都是对程序中一个变量或状态的间接引用。这意味着对任一引用类型数据的修改都会影响所有该引用的拷贝。</p><p>Go语言的数值类型包括几种不同大小的整数、浮点数和复数。每种数值类型都决定了对应的大小范围和是否支持正负符号。</p><h2 id="_3-1-整型" tabindex="-1"><a class="header-anchor" href="#_3-1-整型"><span>3.1. 整型</span></a></h2><h3 id="不同的整型-值域" tabindex="-1"><a class="header-anchor" href="#不同的整型-值域"><span>不同的整型&amp;值域</span></a></h3><p>Go语言同时提供了有符号和无符号类型的整数运算。</p><ul><li>int8、int16、int32和int64四种截然不同大小的有符号整数类型，分别对应8、16、32、64bit大小的有符号整数，与此对应的是uint8、uint16、uint32和uint64四种无符号整数类型。</li><li>两种一般对应特定CPU平台机器字大小的有符号和无符号整数int和uint；其中int是应用最广泛的数值类型。不同的编译器即使在相同的硬件平台上可能产生不同的大小。</li><li>Unicode字符rune类型是和int32等价的类型，通常用于表示一个Unicode码点。这两个名称可以互换使用。</li><li>byte也是uint8类型的等价类型，byte类型一般用于强调数值是一个原始的数据而不是一个小的整数。</li><li>无符号的整数类型uintptr，没有指定具体的bit大小但是足以容纳指针。uintptr类型只有在底层编程时才需要，特别是Go语言和C语言函数库或操作系统接口相交互的地方。</li></ul><p>不管它们的具体大小，int、uint和uintptr是不同类型的兄弟类型。其中int和int32也是不同的类型，即使int的大小也是32bit，在需要将int当作int32类型的地方需要一个显式的类型转换操作，反之亦然。</p><p><strong>值域</strong></p><p>其中有符号整数采用2的补码形式表示，也就是最高bit位用来表示符号位，一个n-bit的有符号数的值域是从-2n-1到2n-1-1。无符号整数的所有bit位都用于表示非负数，值域是0到2n-1。例如，int8类型整数的值域是从-128到127，而uint8类型整数的值域是从0到255。</p><h3 id="二元运算符" tabindex="-1"><a class="header-anchor" href="#二元运算符"><span>二元运算符</span></a></h3><p>下面是Go语言中关于算术运算、逻辑运算和比较运算的二元运算符，它们按照优先级递减的顺序排列：</p><pre><code>*      /      %      &lt;&lt;       &gt;&gt;     &amp;       &amp;^
+      -      |      ^
==     !=     &lt;      &lt;=       &gt;      &gt;=
&amp;&amp;
||
</code></pre><p>二元运算符有五种优先级。在同一个优先级，使用左优先结合规则，但是使用括号可以明确优先顺序，使用括号也可以用于提升优先级，例如 <code>mask &amp; (1 &lt;&lt; 28)</code>。对于上表中前两行的运算符，例如+运算符还有一个与赋值相结合的对应运算符+=，可以用于简化赋值语句。</p><h4 id="算数运算符" tabindex="-1"><a class="header-anchor" href="#算数运算符"><span>算数运算符</span></a></h4><ul><li>算术运算符 <code>+</code>、<code>-</code>、<code>*</code>和 <code>/</code>可以适用于整数、浮点数和复数，但是取模运算符%仅用于整数间的运算。</li><li>对于不同编程语言，%取模运算的行为可能并不相同。在Go语言中，%取模运算符的符号和被取模数的符号总是一致的，因此 <code>-5%3</code>和 <code>-5%-3</code>结果都是-2。</li><li>除法运算符 <code>/</code>的行为则依赖于操作数是否全为整数，比如 <code>5.0/4.0</code>的结果是1.25，但是5/4的结果是1，因为整数除法会向着0方向截断余数。</li></ul><p><strong>结果溢出</strong></p><p>一个算术运算的结果，不管是有符号或者是无符号的，如果需要更多的bit位才能正确表示的话，就说明计算结果是溢出了。超出的高位的bit位部分将被丢弃。如果原始的数值是有符号类型，而且最左边的bit位是1的话，那么最终结果可能是负的，例如int8的例子：</p><pre><code class="language-Go">var u uint8 = 255
fmt.Println(u, u+1, u*u) // &quot;255 0 1&quot;

var i int8 = 127
fmt.Println(i, i+1, i*i) // &quot;127 -128 1&quot;
</code></pre><h4 id="比较运算符" tabindex="-1"><a class="header-anchor" href="#比较运算符"><span>比较运算符</span></a></h4><p>两个相同的整数类型可以使用下面的二元比较运算符进行比较；比较表达式的结果是布尔类型。</p><pre><code>==    等于
!=    不等于
&lt;     小于
&lt;=    小于等于
&gt;     大于
&gt;=    大于等于
</code></pre><p>事实上，布尔型、数字类型和字符串等基本类型都是可比较的，也就是说两个相同类型的值可以用==和!=进行比较。此外，整数、浮点数和字符串可以根据比较结果排序。许多其它类型的值可能是不可比较的，因此也就可能是不可排序的。对于我们遇到的每种类型，我们需要保证规则的一致性。</p><h3 id="其他运算符" tabindex="-1"><a class="header-anchor" href="#其他运算符"><span>其他运算符</span></a></h3><h4 id="一元的加减法运算符" tabindex="-1"><a class="header-anchor" href="#一元的加减法运算符"><span>一元的加减法运算符</span></a></h4><p>这里是一元的加法和减法运算符：</p><pre><code>+      一元加法（无效果）
-      负数
</code></pre><p>对于整数，+x是0+x的简写，-x则是0-x的简写；对于浮点数和复数，+x就是x，-x则是x 的负数。</p><h4 id="bit位操作运算符" tabindex="-1"><a class="header-anchor" href="#bit位操作运算符"><span>bit位操作运算符</span></a></h4><p>Go语言还提供了以下的bit位操作运算符，前面4个操作运算符并不区分是有符号还是无符号数：</p><pre><code>&amp;      位运算 AND
|      位运算 OR
^      位运算 XOR
&amp;^     位清空 AND(a, NOT(b))
&lt;&lt;     左移
&gt;&gt;     右移
</code></pre><p>位操作运算符 <code>^</code>作为二元运算符时是按位异或（XOR），当用作一元运算符时表示按位取反；也就是说，它返回一个每个bit位都取反的数。</p><p>位操作运算符 <code>&amp;^</code>用于按位置零（AND NOT）：如果对应y中bit位为1的话，表达式 <code>z = x &amp;^ y</code>结果z的对应的bit位为0，否则z对应的bit位等于x相应的bit位的值。</p><h3 id="无符号-有符号" tabindex="-1"><a class="header-anchor" href="#无符号-有符号"><span>无符号&amp;有符号</span></a></h3><p>下面的代码演示了如何使用位操作解释uint8类型值的8个独立的bit位。</p><p>使用Printf函数的%b参数打印二进制格式的数字；其中%08b中08表示打印至少8个字符宽度，不足的前缀部分用0填充。</p><pre><code class="language-go"><span class="token keyword">var</span> x <span class="token builtin">uint8</span> <span class="token operator">=</span> <span class="token number">1</span><span class="token operator">&lt;&lt;</span><span class="token number">1</span> <span class="token operator">|</span> <span class="token number">1</span><span class="token operator">&lt;&lt;</span><span class="token number">5</span>
...
fmt<span class="token punctuation">.</span><span class="token function">Printf</span><span class="token punctuation">(</span><span class="token string">&quot;%08b\\n&quot;</span><span class="token punctuation">,</span> x<span class="token operator">&gt;&gt;</span><span class="token number">1</span><span class="token punctuation">)</span> <span class="token comment">// &quot;00010001&quot;, the set {0, 4}</span>
...
</code></pre><figure><img src="`+o+`" alt="1712132982776" tabindex="0" loading="lazy"><figcaption>1712132982776</figcaption></figure><p>在x&lt;&lt;n和x&gt;&gt;n移位运算中，n必须是无符号数，x均可。例如上面用i := int(-1)就编不过</p><pre><code class="language-go"><span class="token keyword">for</span> i <span class="token operator">:=</span> <span class="token function">int</span><span class="token punctuation">(</span><span class="token operator">-</span><span class="token number">1</span><span class="token punctuation">)</span><span class="token punctuation">;</span> i <span class="token operator">&lt;</span> <span class="token number">8</span><span class="token punctuation">;</span> i<span class="token operator">++</span> <span class="token punctuation">{</span>
		<span class="token comment">// NOTE: 此处i是无符号整型，才能实现1&lt;&lt;i，例如上面用i := int(-1)就编不过</span>
		<span class="token keyword">if</span> x<span class="token operator">&amp;</span><span class="token punctuation">(</span><span class="token number">1</span><span class="token operator">&lt;&lt;</span>i<span class="token punctuation">)</span> <span class="token operator">!=</span> <span class="token number">0</span> <span class="token punctuation">{</span> <span class="token comment">// membership test</span>
			fmt<span class="token punctuation">.</span><span class="token function">Println</span><span class="token punctuation">(</span>i<span class="token punctuation">)</span> <span class="token comment">// &quot;1&quot;, &quot;5&quot;</span>
		<span class="token punctuation">}</span>
	<span class="token punctuation">}</span>
</code></pre><p>算术上，一个x&lt;&lt;n左移运算等价于乘以$2<sup>n$，一个x&gt;&gt;n右移运算等价于除以$2</sup>n$。</p><p>左移运算用零填充右边空缺的bit位，无符号数的右移运算也是用0填充左边空缺的bit位，但是有符号数的右移运算会用符号位的值填充左边空缺的bit位。因为这个原因，最好用无符号运算，这样你可以将整数完全当作一个bit位模式处理。</p><p>尽管Go语言提供了无符号数的运算，但即使数值本身不可能出现负数，我们还是倾向于使用有符号的int类型，就像数组的长度那样，虽然使用uint无符号类型似乎是一个更合理的选择。事实上，内置的len函数返回一个有符号的int，我们可以像下面例子那样处理逆序循环。</p><pre><code class="language-go">	medals <span class="token operator">:=</span> <span class="token punctuation">[</span><span class="token punctuation">]</span><span class="token builtin">string</span><span class="token punctuation">{</span><span class="token string">&quot;gold&quot;</span><span class="token punctuation">,</span> <span class="token string">&quot;silver&quot;</span><span class="token punctuation">,</span> <span class="token string">&quot;bronze&quot;</span><span class="token punctuation">}</span>
	...
	<span class="token punctuation">}</span>
</code></pre><p>在三次迭代之后，也就是i == 0时，i--语句将不会产生-1，而是变成一个uint类型的最大值（可能是$2^64-1$），然后medals[i]表达式运行时将发生panic异常（§5.9），也就是试图访问一个slice范围以外的元素。</p><blockquote><p>无符号数往往只有在位运算或其它特殊的运算场景才会使用，就像bit集合、分析二进制文件格式或者是哈希和加密操作等。它们通常并不用于仅仅是表达非负数量的场合。</p></blockquote><h3 id="数值类型转换" tabindex="-1"><a class="header-anchor" href="#数值类型转换"><span>数值类型转换</span></a></h3><p>需要一个显式的转换将一个值从一种类型转化为另一种类型，并且算术和逻辑运算的二元操作中必须是相同的类型。类似下面代码的常见的错误：</p><pre><code class="language-Go">var apples int32 = 1
var oranges int16 = 2
var compote int = apples + oranges // compile error
</code></pre><p>当尝试编译这三个语句时，将产生一个错误信息：</p><pre><code>invalid operation: apples + oranges (mismatched types int32 and int16)
</code></pre><p>这种类型不匹配的问题可以有几种不同的方法修复，最常见方法是将它们都显式转型为一个常见类型：</p><pre><code class="language-Go">var compote = int(apples) + int(oranges)
</code></pre><p>如2.5节所述，对于每种类型T，如果转换允许的话，类型转换操作T(x)将x转换为T类型。许多整数之间的相互转换并不会改变数值；它们只是告诉编译器如何解释这个值。但是对于将一个大尺寸的整数类型转为一个小尺寸的整数类型，或者是将一个浮点数转为整数，可能会改变数值或丢失精度：</p><pre><code class="language-Go">f := 3.141 // a float64
i := int(f)
fmt.Println(f, i) // &quot;3.141 3&quot;
f = 1.99
fmt.Println(int(f)) // &quot;1&quot;
</code></pre><p>浮点数到整数的转换将丢失任何小数部分，然后向数轴零方向截断。你应该避免对可能会超出目标类型表示范围的数值做类型转换，因为截断的行为可能依赖于具体的实现：</p><pre><code class="language-Go">f := 1e100  // a float64
i := int(f) // 结果依赖于具体实现
</code></pre><figure><img src="`+c+`" alt="image-20240409145949392" tabindex="0" loading="lazy"><figcaption>image-20240409145949392</figcaption></figure><ul><li>任何大小的整数字面值都可以用以0开始的八进制格式书写，例如0666，八进制数据通常用于POSIX操作系统上的文件访问权限标志；</li><li>或用以0x或0X开头的十六进制格式书写，例如0xdeadbeef，（大小写都可），十六进制数字则更强调数字值的bit位模式。</li></ul><h3 id="格式化输出整型" tabindex="-1"><a class="header-anchor" href="#格式化输出整型"><span>格式化输出整型</span></a></h3><p>当使用fmt包打印一个数值时，我们可以用 <code>%d</code>、<code>%o</code>或 <code>%x</code>参数控制输出的进制格式</p><pre><code class="language-Go">o := 0666
fmt.Printf(&quot;%d %[1]o %#[1]o\\n&quot;, o) // &quot;438 666 0666&quot;
x := int64(0xdeadbeef)
fmt.Printf(&quot;%d %[1]x %#[1]x %#[1]X\\n&quot;, x)
// Output:
// 3735928559 deadbeef 0xdeadbeef 0XDEADBEEF
</code></pre><p>意义：</p><ol><li>%d 是格式化占位符，表示按照十进制格式输出一个整数。</li><li>%[1]o 是格式化占位符的扩展用法，[1] 表示引用第一个参数，o 表示按照八进制格式输出一个整数。</li><li>%#[1]o 是格式化占位符的扩展用法，# 表示输出格式带有前缀，[1] 表示引用第一个参数，o 表示按照八进制格式输出一个整数。</li><li>%[1]x类似%[1]o，x表示十六进制</li><li>%#[1]x带前缀，十六进制，前缀为0x</li><li>%#[1]X带前缀，十六进制，前缀为0X</li></ol><p>字符也可以转成整型，也就是转成他的Unicode，字符使用 <code>%c</code>参数打印，或者是用 <code>%q</code>参数打印带单引号的字符：</p><pre><code class="language-go">ascii <span class="token operator">:=</span> <span class="token char">&#39;a&#39;</span>
...
</code></pre><figure><img src="`+e+`" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><h2 id="_3-2-浮点数" tabindex="-1"><a class="header-anchor" href="#_3-2-浮点数"><span>3.2. 浮点数</span></a></h2><h3 id="浮点数精度" tabindex="-1"><a class="header-anchor" href="#浮点数精度"><span>浮点数精度</span></a></h3><p>Go提供两种精度的浮点数，float32和float64。浮点数的范围极限可以在math包中找到。常量math.MaxFloat32表示float32能表示的最大数值，大约是 3.4e38；对应的math.MaxFloat64常量大约是1.8e308。它们分别能表示的最小值近似为1.4e-45和4.9e-324。一个float32类型的浮点数可以提供大约6个十进制数的精度，而float64则可以提供约15个十进制数的精度；</p><p>通常应该优先使用float64类型，因为float32类型的累计计算误差很容易扩散，float32的有效bit位只有23个，其它的bit位用于指数和符号；当整数大于23bit能表达的范围时，float32的表示将出现误差：</p><pre><code class="language-go"><span class="token keyword">var</span> f <span class="token builtin">float32</span> <span class="token operator">=</span> <span class="token number">16777216</span> <span class="token comment">// 1 &lt;&lt; 24</span>
...
</code></pre><p>浮点数的字面值可以直接写小数部分，像这样：</p><pre><code class="language-go"><span class="token keyword">const</span> e <span class="token operator">=</span> <span class="token number">2.71828</span> <span class="token comment">// (approximately)</span>
</code></pre><p>小数点前面或后面的数字都可能被省略（例如.707或1.）。很小或很大的数最好用科学计数法书写，通过e或E来指定指数部分：</p><pre><code class="language-go"><span class="token keyword">const</span> Avogadro <span class="token operator">=</span> <span class="token number">6.02214129e23</span>  <span class="token comment">// 阿伏伽德罗常数</span>
...
</code></pre><p>用Printf函数的%g参数打印浮点数，将采用更紧凑的表示形式打印，并提供足够的精度，但是对应表格的数据，使用%e（带指数）或%f的形式打印可能更合适。所有的这三个打印形式都可以指定打印的宽度和控制打印精度。</p><pre><code class="language-go"><span class="token keyword">for</span> x <span class="token operator">:=</span> <span class="token number">0</span><span class="token punctuation">;</span> x <span class="token operator">&lt;</span> <span class="token number">8</span><span class="token punctuation">;</span> x<span class="token operator">++</span> <span class="token punctuation">{</span>
...
<span class="token punctuation">}</span>
</code></pre><p>上面代码打印e的幂，打印精度是小数点后三个小数精度和8个字符宽度：</p><figure><img src="`+u+`" alt="1712825319476" tabindex="0" loading="lazy"><figcaption>1712825319476</figcaption></figure><p>&lt;&lt;&lt;&lt;&lt;&lt;&lt; HEAD</p><h3 id="浮点数特殊值" tabindex="-1"><a class="header-anchor" href="#浮点数特殊值"><span>浮点数特殊值</span></a></h3><p>=======</p><blockquote><blockquote><blockquote><blockquote><blockquote><blockquote><blockquote><p>96567323cfc2043fbd664cc254d198a3cc1f5994 math包中除了提供大量常用的数学函数外，还提供了IEEE754浮点数标准中定义的特殊值的创建和测试：正无穷大和负无穷大，分别用于表示太大溢出的数字和除零的结果；还有NaN非数，一般用于表示无效的除法操作结果0/0或Sqrt(-1).</p></blockquote></blockquote></blockquote></blockquote></blockquote></blockquote></blockquote><pre><code class="language-go"><span class="token keyword">var</span> z <span class="token builtin">float64</span>
...
</code></pre><p>函数<code>math.IsNaN</code>用于测试一个数是否是非数NaN，<code>math.NaN</code>则返回非数对应的值。虽然可以用<code>math.NaN</code>来表示一个非法的结果，但是测试一个结果是否是非数NaN则是充满风险的，因为NaN和任何数都是不相等的（译注：在浮点数中，NaN、正无穷大和负无穷大都不是唯一的，每个都有非常多种的bit模式表示）：</p><pre><code class="language-go">nan <span class="token operator">:=</span> math<span class="token punctuation">.</span><span class="token function">NaN</span><span class="token punctuation">(</span><span class="token punctuation">)</span>
...
</code></pre><figure><img src="`+l+`" alt="image-20240411172248377" tabindex="0" loading="lazy"><figcaption>image-20240411172248377</figcaption></figure><p>如果一个函数返回的浮点数结果可能失败，最好的做法是用单独的标志报告失败，像这样：</p><pre><code class="language-go"><span class="token keyword">func</span> <span class="token function">compute</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">(</span>value <span class="token builtin">float64</span><span class="token punctuation">,</span> ok <span class="token builtin">bool</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
...
<span class="token punctuation">}</span>
</code></pre><p>接下来的程序演示了通过浮点计算生成的图形。它是带有两个参数的z = f(x, y)函数的三维形式，使用了可缩放矢量图形（SVG）格式输出，SVG是一个用于矢量线绘制的XML标准。图3.1显示了sin(r)/r函数的输出图形，其中r是<code>sqrt(x*x+y*y)</code>。</p><figure><img src="`+k+`" alt="image-20240415134037655" tabindex="0" loading="lazy"><figcaption>image-20240415134037655</figcaption></figure><pre><code class="language-go"><span class="token comment">// Surface computes an SVG rendering of a 3-D surface function.</span>
...
<span class="token punctuation">}</span>
...
</code></pre><h3 id="练习-3-1" tabindex="-1"><a class="header-anchor" href="#练习-3-1"><span>练习 3.1</span></a></h3><p>如果f函数返回的是无限制的float64值，那么SVG文件可能输出无效的多边形元素（虽然许多SVG渲染器会妥善处理这类问题）。修改程序跳过无效的多边形。</p><p>在for循环里处理一下corner函数的返回值：</p><pre><code class="language-go">	<span class="token keyword">for</span> i <span class="token operator">:=</span> <span class="token number">0</span><span class="token punctuation">;</span> i <span class="token operator">&lt;</span> cells<span class="token punctuation">;</span> i<span class="token operator">++</span> <span class="token punctuation">{</span>
		<span class="token keyword">for</span> j <span class="token operator">:=</span> <span class="token number">0</span><span class="token punctuation">;</span> j <span class="token operator">&lt;</span> cells<span class="token punctuation">;</span> j<span class="token operator">++</span> <span class="token punctuation">{</span>
			ax<span class="token punctuation">,</span> ay <span class="token operator">:=</span> <span class="token function">corner</span><span class="token punctuation">(</span>i<span class="token operator">+</span><span class="token number">1</span><span class="token punctuation">,</span> j<span class="token punctuation">)</span>
			bx<span class="token punctuation">,</span> by <span class="token operator">:=</span> <span class="token function">corner</span><span class="token punctuation">(</span>i<span class="token punctuation">,</span> j<span class="token punctuation">)</span>
			cx<span class="token punctuation">,</span> cy <span class="token operator">:=</span> <span class="token function">corner</span><span class="token punctuation">(</span>i<span class="token punctuation">,</span> j<span class="token operator">+</span><span class="token number">1</span><span class="token punctuation">)</span>
		...
		<span class="token punctuation">}</span>
</code></pre><h3 id="练习-3-2" tabindex="-1"><a class="header-anchor" href="#练习-3-2"><span>练习 3.2</span></a></h3><p>试验math包中其他函数的渲染图形。你是否能输出一个egg box、moguls或a saddle图案?</p><p>把原本的f(x)改成别的函数</p><pre><code class="language-go"><span class="token keyword">func</span> <span class="token function">f</span><span class="token punctuation">(</span>x<span class="token punctuation">,</span> y <span class="token builtin">float64</span><span class="token punctuation">)</span> <span class="token builtin">float64</span> <span class="token punctuation">{</span>
	r <span class="token operator">:=</span> math<span class="token punctuation">.</span><span class="token function">Hypot</span><span class="token punctuation">(</span>x<span class="token punctuation">,</span> y<span class="token punctuation">)</span> <span class="token comment">// distance from (0,0)</span>
	<span class="token keyword">return</span> math<span class="token punctuation">.</span><span class="token function">Sin</span><span class="token punctuation">(</span>r<span class="token punctuation">)</span> <span class="token operator">/</span> r
<span class="token punctuation">}</span>
...
<span class="token keyword">func</span> <span class="token function">saddle</span><span class="token punctuation">(</span>x<span class="token punctuation">,</span> y <span class="token builtin">float64</span><span class="token punctuation">)</span> <span class="token builtin">float64</span> <span class="token punctuation">{</span> <span class="token comment">//马鞍</span>
	...
	<span class="token keyword">return</span> r
<span class="token punctuation">}</span>
</code></pre><h3 id="练习-3-3" tabindex="-1"><a class="header-anchor" href="#练习-3-3"><span>练习 3.3</span></a></h3><p>根据高度给每个多边形上色，那样峰值部将是红色（#ff0000），谷部将是蓝色（#0000ff）。</p><p>感觉不难 但我不会</p><h3 id="练习-3-4" tabindex="-1"><a class="header-anchor" href="#练习-3-4"><span>练习 3.4</span></a></h3><p>参考1.7节Lissajous例子的函数，构造一个web服务器，用于计算函数曲面然后返回SVG数据给客户端。允许客户端通过HTTP请求参数设置高度、宽度和颜色等参数。</p><p>服务器必须设置Content-Type头部：（因为服务器使用标准的PNG图像格式，可以根据前面的512个字节自动输出对应的头部。</p><pre><code class="language-go">w<span class="token punctuation">.</span><span class="token function">Header</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">.</span><span class="token function">Set</span><span class="token punctuation">(</span><span class="token string">&quot;Content-Type&quot;</span><span class="token punctuation">,</span> <span class="token string">&quot;image/svg+xml&quot;</span><span class="token punctuation">)</span>
</code></pre><p>打印异常的时候还得把&quot;Content-Type&quot;转成text，要不然：</p><figure><img src="`+i+`" alt="image-20240415143331842" tabindex="0" loading="lazy"><figcaption>image-20240415143331842</figcaption></figure><pre><code class="language-go"><span class="token keyword">package</span> main
...
</code></pre><h2 id="_3-3-复数" tabindex="-1"><a class="header-anchor" href="#_3-3-复数"><span>3.3. 复数</span></a></h2><h3 id="复数表达式" tabindex="-1"><a class="header-anchor" href="#复数表达式"><span>复数表达式</span></a></h3><p>Go语言提供了两种精度的复数类型：complex64和complex128，分别对应float32和float64两种浮点数精度。内置的complex函数用于构建复数，内建的real和imag函数分别返回复数的实部和虚部：</p><pre><code class="language-go"><span class="token keyword">var</span> x <span class="token builtin">complex128</span> <span class="token operator">=</span> <span class="token function">complex</span><span class="token punctuation">(</span><span class="token number">1</span><span class="token punctuation">,</span> <span class="token number">2</span><span class="token punctuation">)</span> <span class="token comment">// 1+2i</span>
...
</code></pre><p>如果一个浮点数面值或一个十进制整数面值后面跟着一个i，例如3.141592i或2i，它将构成一个复数的虚部，复数的实部是0：</p><pre><code class="language-go">fmt<span class="token punctuation">.</span><span class="token function">Println</span><span class="token punctuation">(</span><span class="token number">1i</span> <span class="token operator">*</span> <span class="token number">1i</span><span class="token punctuation">)</span> <span class="token comment">// &quot;(-1+0i)&quot;, i^2 = -1</span>
</code></pre><p>在常量算术规则下，一个复数常量可以加到另一个普通数值常量（整数或浮点数、实部或虚部），我们可以用自然的方式书写复数，就像1+2i或与之等价的写法2i+1。上面x和y的声明语句还可以简化：</p><pre><code class="language-go">x <span class="token operator">:=</span> <span class="token number">1</span> <span class="token operator">+</span> <span class="token number">2i</span>
...
</code></pre><p>复数也可以用==和!=进行相等比较。只有两个复数的实部和虚部都相等的时候它们才是相等的（译注：浮点数的相等比较是危险的，需要特别小心处理精度问题）。</p><h3 id="math-cmplx包" tabindex="-1"><a class="header-anchor" href="#math-cmplx包"><span>math/cmplx包</span></a></h3><p>math/cmplx包提供了复数处理的许多函数，例如求复数的平方根函数和求幂函数。</p><pre><code class="language-go">fmt<span class="token punctuation">.</span><span class="token function">Println</span><span class="token punctuation">(</span>cmplx<span class="token punctuation">.</span><span class="token function">Sqrt</span><span class="token punctuation">(</span><span class="token operator">-</span><span class="token number">1</span><span class="token punctuation">)</span><span class="token punctuation">)</span> <span class="token comment">// &quot;(0+1i)&quot;</span>
</code></pre><p>下面的程序使用complex128复数算法来生成一个Mandelbrot图像。</p><pre><code class="language-go"><span class="token comment">// Mandelbrot emits a PNG image of the Mandelbrot fractal.</span>
<span class="token keyword">package</span> main
...
</code></pre><p>用于遍历1024*1024图像每个点的两个嵌套的循环对应-2到+2区间的复数平面。程序反复测试每个点对应复数值平方值加一个增量值对应的点是否超出半径为2的圆。如果超过了，通过根据预设置的逃逸迭代次数对应的灰度颜色来代替。如果不是，那么该点属于Mandelbrot集合，使用黑色颜色标记。最终程序将生成的PNG格式分形图像输出到标准输出。</p><figure><img src="`+r+'" alt="image-20240415153834143" tabindex="0" loading="lazy"><figcaption>image-20240415153834143</figcaption></figure><blockquote><p>[!NOTE]</p><p>此处要用cmd执行go run mandelbrot.go &gt; out.png ，要不然powershell会出问题：</p><figure><img src="'+m+`" alt="image-20240415153609218" tabindex="0" loading="lazy"><figcaption>image-20240415153609218</figcaption></figure></blockquote><h3 id="练习-3-5" tabindex="-1"><a class="header-anchor" href="#练习-3-5"><span>练习 3.5</span></a></h3><p>实现一个彩色的Mandelbrot图像，使用image.NewRGBA创建图像，使用color.RGBA或color.YCbCr生成颜色。</p><p>添加一个选择颜色的函数，替换原来的灰度，颜色参考https://stackoverflow.com/questions/16500656/which-color-gradient-is-used-to-color-mandelbrot-in-wikipedia</p><pre><code class="language-go"><span class="token keyword">func</span> <span class="token function">mandelbrot</span><span class="token punctuation">(</span>z <span class="token builtin">complex128</span><span class="token punctuation">)</span> color<span class="token punctuation">.</span>Color <span class="token punctuation">{</span>
	<span class="token keyword">const</span> iterations <span class="token operator">=</span> <span class="token number">200</span>
...
<span class="token punctuation">}</span>
</code></pre><h3 id="练习-3-6" tabindex="-1"><a class="header-anchor" href="#练习-3-6"><span>练习 3.6</span></a></h3><p>升采样技术可以降低每个像素对计算颜色值和平均值的影响。简单的方法是将每个像素分成四个子像素，实现它。</p><p>原本使用坐标x,y直接算个颜色出来，现在是取坐标x,y四周的四个点，算出颜色的平均值（将r、g、b、a四个的值求平均）</p><pre><code class="language-go"><span class="token keyword">package</span> main
...
</code></pre><h3 id="练习-3-7" tabindex="-1"><a class="header-anchor" href="#练习-3-7"><span>练习 3.7</span></a></h3><p>另一个生成分形图像的方式是使用牛顿法来求解一个复数方程，例如$z^4-1=0$。每个起点到四个根的迭代次数对应阴影的灰度。方程根对应的点用颜色表示。</p><pre><code class="language-go"><span class="token keyword">package</span> main
...
</code></pre><h3 id="练习-3-8" tabindex="-1"><a class="header-anchor" href="#练习-3-8"><span>练习 3.8</span></a></h3><p>通过提高精度来生成更多级别的分形。使用四种不同精度类型的数字实现相同的分形：complex64、complex128、big.Float和big.Rat。（后面两种类型在math/big包声明。Float是有指定限精度的浮点数；Rat是无限精度的有理数。）它们间的性能和内存使用对比如何？当渲染图可见时缩放的级别是多少？</p><pre><code class="language-go"><span class="token keyword">func</span> <span class="token function">mandelbrot128</span><span class="token punctuation">(</span>z <span class="token builtin">complex128</span><span class="token punctuation">)</span> color<span class="token punctuation">.</span>Color <span class="token punctuation">{</span>
	<span class="token keyword">const</span> iterations <span class="token operator">=</span> <span class="token number">200</span>
	<span class="token keyword">var</span> v <span class="token builtin">complex128</span>
	<span class="token keyword">for</span> n <span class="token operator">:=</span> <span class="token function">uint8</span><span class="token punctuation">(</span><span class="token number">0</span><span class="token punctuation">)</span><span class="token punctuation">;</span> n <span class="token operator">&lt;</span> iterations<span class="token punctuation">;</span> n<span class="token operator">++</span> <span class="token punctuation">{</span>
		v <span class="token operator">=</span> v<span class="token operator">*</span>v <span class="token operator">+</span> z
...
</code></pre><h3 id="练习-3-9" tabindex="-1"><a class="header-anchor" href="#练习-3-9"><span>练习 3.9</span></a></h3><p>编写一个web服务器，用于给客户端生成分形的图像。运行客户端通过HTTP参数指定x、y和zoom参数。</p><pre><code class="language-go"><span class="token keyword">package</span> main
...
</code></pre><h2 id="_3-4-布尔型" tabindex="-1"><a class="header-anchor" href="#_3-4-布尔型"><span>3.4. 布尔型</span></a></h2><p>布尔类型的值：true和false。if和for语句的条件部分都是布尔类型的值，==和&lt;等比较操作也会产生布尔型的值。一元操作符!对应逻辑非操作，<code>!true</code>的值为<code>false</code>。</p><p>布尔值可以和<code>&amp;&amp;</code>（AND）和<code>||</code>（OR）操作符结合，并且有短路行为：如果运算符左边值已经可以确定整个布尔表达式的值，那么运算符右边的值将不再被求值，下面的表达式总是安全的：</p><pre><code class="language-go">s <span class="token operator">!=</span> <span class="token string">&quot;&quot;</span> <span class="token operator">&amp;&amp;</span> s<span class="token punctuation">[</span><span class="token number">0</span><span class="token punctuation">]</span> <span class="token operator">==</span> <span class="token char">&#39;x&#39;</span>
</code></pre><p>因为<code>&amp;&amp;</code>的优先级比<code>||</code>高</p><p>下面形式的布尔表达式是不需要加小括弧的：</p><pre><code class="language-go"><span class="token keyword">if</span> <span class="token char">&#39;a&#39;</span> <span class="token operator">&lt;=</span> c <span class="token operator">&amp;&amp;</span> c <span class="token operator">&lt;=</span> <span class="token char">&#39;z&#39;</span> <span class="token operator">||</span>
...
<span class="token punctuation">}</span>
</code></pre><p>布尔值并不会隐式转换为数字值0或1，反之亦然。必须使用一个显式的if语句辅助转换：</p><pre><code class="language-go">i <span class="token operator">:=</span> <span class="token number">0</span>
<span class="token keyword">if</span> b <span class="token punctuation">{</span>
    i <span class="token operator">=</span> <span class="token number">1</span>
<span class="token punctuation">}</span>
</code></pre><p>如果需要经常做类似的转换，包装成一个函数会更方便：</p><pre><code class="language-go"><span class="token comment">// btoi returns 1 if b is true and 0 if false.</span>
<span class="token keyword">func</span> <span class="token function">btoi</span><span class="token punctuation">(</span>b <span class="token builtin">bool</span><span class="token punctuation">)</span> <span class="token builtin">int</span> <span class="token punctuation">{</span>
    ...
    <span class="token keyword">return</span> <span class="token number">0</span>
<span class="token punctuation">}</span>
</code></pre><p>数字到布尔型的逆转换则非常简单，不过为了保持对称，我们也可以包装一个函数：</p><pre><code class="language-go"><span class="token comment">// itob reports whether i is non-zero.</span>
...
</code></pre><h2 id="_3-5-字符串" tabindex="-1"><a class="header-anchor" href="#_3-5-字符串"><span>3.5. 字符串</span></a></h2><p>一个字符串是一个不可改变的字节序列。字符串可以包含任意的数据，包括byte值0，但是通常是用来包含人类可读的文本。文本字符串通常被解释为采用UTF8编码的Unicode码点（rune）序列。</p><p>内置的<strong>len函数</strong>可以返回一个字符串中的字节数目（不是rune字符数目），索引操作s[i]返回第i个字节的字节值，i必须满足0 ≤ i&lt; len(s)条件约束。</p><pre><code class="language-go">s <span class="token operator">:=</span> <span class="token string">&quot;hello, world&quot;</span>
...
</code></pre><p>如果试图访问超出字符串索引范围的字节将会导致panic异常：</p><pre><code class="language-Go">c := s[len(s)] // panic: index out of range
</code></pre><p>第i个字节并不一定是字符串的第i个字符，因为对于非ASCII字符的UTF8编码会要两个或多个字节。我们先简单说下字符的工作方式。</p><p><strong>子字符串</strong>操作s[i:j]基于原始的s字符串的第i个字节开始到第j个字节（并不包含j本身）生成一个新字符串。生成的新字符串将包含j-i个字节。</p><pre><code class="language-Go">fmt.Println(s[0:5]) // &quot;hello&quot;
</code></pre><p>同样，如果索引超出字符串范围或者j小于i的话将导致panic异常。</p><figure><img src="`+d+`" alt="image-20240416134123069" tabindex="0" loading="lazy"><figcaption>image-20240416134123069</figcaption></figure><p>不管i还是j都可能被忽略，当它们被忽略时将采用0作为开始位置，采用len(s)作为结束的位置。</p><pre><code class="language-Go">fmt.Println(s[:5]) // &quot;hello&quot;
fmt.Println(s[7:]) // &quot;world&quot;
fmt.Println(s[:])  // &quot;hello, world&quot;
</code></pre><p><strong>+操作符</strong>将两个字符串连接构造一个新字符串：</p><pre><code class="language-Go">fmt.Println(&quot;goodbye&quot; + s[5:]) // &quot;goodbye, world&quot;
</code></pre><p>字符串可以用==和&lt;进行<strong>比较</strong>；比较通过逐个字节比较完成的，因此比较的结果是字符串自然编码的顺序。</p><p><strong>字符串的值是不可变的</strong>：一个字符串包含的字节序列永远不会被改变，当然我们也可以给一个字符串变量分配一个新字符串值。可以像下面这样将一个字符串追加到另一个字符串：</p><pre><code class="language-Go">s := &quot;left foot&quot;
t := s
s += &quot;, right foot&quot;
</code></pre><p>这并不会导致原始的字符串值被改变，但是变量s将因为+=语句持有一个新的字符串值，但是t依然是包含原先的字符串值。</p><pre><code class="language-Go">fmt.Println(s) // &quot;left foot, right foot&quot;
fmt.Println(t) // &quot;left foot&quot;
</code></pre><p>因为字符串是不可修改的，因此尝试修改字符串内部数据的操作也是被禁止的：</p><pre><code class="language-Go">s[0] = &#39;L&#39; // compile error: cannot assign to s[0]
</code></pre><figure><img src="`+f+'" alt="image-20240416134927313" tabindex="0" loading="lazy"><figcaption>image-20240416134927313</figcaption></figure><p>不变性意味着如果两个字符串共享相同的底层数据的话也是安全的，这使得复制任何长度的字符串代价是低廉的。同样，一个字符串s和对应的子字符串切片s[7:]的操作也可以安全地共享相同的内存，因此字符串切片操作代价也是低廉的。在这两种情况下都没有必要分配新的内存。 图3.4演示了一个字符串和两个子串共享相同的底层数据。</p><figure><img src="'+g+`" alt="img" tabindex="0" loading="lazy"><figcaption>img</figcaption></figure><h3 id="_3-5-1-字符串面值" tabindex="-1"><a class="header-anchor" href="#_3-5-1-字符串面值"><span>3.5.1. 字符串面值</span></a></h3><p>字符串值也可以用字符串面值方式编写，只要将一系列字节序列包含在双引号内即可：</p><pre><code>&quot;Hello, world&quot;
</code></pre><p>因为Go语言源文件总是用UTF8编码，并且Go语言的文本字符串也以UTF8编码的方式处理，因此我们可以将Unicode码点也写到字符串面值中。</p><p>在一个双引号包含的字符串面值中，可以用以反斜杠<code>\\</code>开头的转义序列插入任意的数据。下面的换行、回车和制表符等是常见的ASCII控制代码的转义方式：</p><pre><code>\\a      响铃
\\b      退格
\\f      换页
\\n      换行
\\r      回车
...
\\&quot;      双引号（只用在 &quot;...&quot; 形式的字符串面值中）
\\\\      反斜杠
</code></pre><p>可以通过十六进制或八进制转义在字符串面值中包含任意的字节。</p><ul><li>一个十六进制的转义形式是<code>\\xhh</code>，其中两个h表示十六进制数字（大写或小写都可以）。</li><li>一个八进制转义形式是<code>\\ooo</code>，包含三个八进制的o数字（0到7），但是不能超过<code>\\377</code>（译注：对应一个字节的范围，十进制为255）。</li><li>每一个单一的字节表达一个特定的值。</li></ul><p><strong>原生字符串</strong></p><ul><li>一个原生的字符串面值形式是<code>...</code>，使用反引号代替双引号。</li><li>在原生的字符串面值中，没有转义操作；全部的内容都是字面的意思，包含退格和换行，因此一个程序中的原生字符串面值可能跨越多行</li><li>（译注：在原生字符串面值内部是无法直接写反引号字符的，可以用八进制或十六进制转义或+&quot;\`&quot;连接字符串常量完成）。</li><li>唯一的特殊处理是会删除回车以保证在所有平台上的值都是一样的，包括那些把回车也放入文本文件的系统（译注：Windows系统会把回车和换行一起放入文本文件中）。</li></ul><p>原生字符串面值用于编写正则表达式会很方便，因为正则表达式往往会包含很多反斜杠。原生字符串面值同时被广泛应用于HTML模板、JSON面值、命令行提示信息以及那些需要扩展到多行的场景。</p><pre><code class="language-Go">const GoUsage = \`Go is a tool for managing Go source code.

Usage:
    go command [arguments]
...\`
</code></pre><figure><img src="`+b+`" alt="image-20240416140122874" tabindex="0" loading="lazy"><figcaption>image-20240416140122874</figcaption></figure><h3 id="_3-5-2-unicode" tabindex="-1"><a class="header-anchor" href="#_3-5-2-unicode"><span>3.5.2. Unicode</span></a></h3><p>Unicode（ http://unicode.org ），它收集了这个世界上所有的符号系统，包括重音符号和其它变音符号，制表符和回车符，还有很多神秘的符号，每个符号都分配一个唯一的Unicode码点，在第八版本的Unicode标准里收集了超过120,000个字符，涵盖超过100多种语言。</p><p>Unicode码点对应Go语言中的rune整数类型。通用的<strong>表示一个Unicode码点的数据类型是int32</strong>，也就是Go语言中rune对应的类型；它的同义词rune符文正是这个意思。</p><ul><li><p>我们可以将一个符文序列表示为一个int32序列，这种编码方式叫UTF-32或UCS-4，这种方式比较简单统一，但是它会浪费很多存储空间</p></li><li><p>但是，大多数计算机可读的文本是ASCII字符，本来每个ASCII字符只需要8bit或1字节就能表示。而且即使是常用的字符也远少于65,536个，也就是说用16bit编码方式就能表达常用字符。</p></li></ul><h3 id="_3-5-3-utf-8" tabindex="-1"><a class="header-anchor" href="#_3-5-3-utf-8"><span>3.5.3. UTF-8</span></a></h3><p>UTF8是一个将Unicode码点编码为字节序列的变长编码。UTF8编码是由Go语言之父Ken Thompson和Rob Pike共同发明的，现在已经是Unicode的标准。</p><ul><li>UTF8编码使用1到4个字节来表示每个Unicode码点，ASCII部分字符只使用1个字节，常用字符部分使用2或3个字节表示。</li><li>每个符号编码后第一个字节的高端bit位用于表示编码总共有多少个字节。如果第一个字节的高端bit为0，则表示对应7bit的ASCII字符，ASCII字符每个字符依然是一个字节，和传统的ASCII编码兼容。</li><li>如果第一个字节的高端bit是110，则说明需要2个字节；后续的每个高端bit都以10开头。更大的Unicode码点也是采用类似的策略处理。</li></ul><pre><code>0xxxxxxx                             runes 0-127    (ASCII)
110xxxxx 10xxxxxx                    128-2047       (values &lt;128 unused)
1110xxxx 10xxxxxx 10xxxxxx           2048-65535     (values &lt;2048 unused)
11110xxx 10xxxxxx 10xxxxxx 10xxxxxx  65536-0x10ffff (other values unused)
</code></pre><p>变长的编码无法直接通过索引来访问第n个字符，但是UTF8编码获得了很多额外的优点。</p><ul><li>首先UTF8编码比较紧凑，完全兼容ASCII码，并且可以自动同步：它可以通过向前回朔最多3个字节就能确定当前字符编码的开始字节的位置。</li><li>它也是一个前缀编码，所以当从左向右解码时不会有任何歧义也并不需要向前查看（译注：像GBK之类的编码，如果不知道起点位置则可能会出现歧义）。</li><li>没有任何字符的编码是其它字符编码的子串，或是其它编码序列的字串，因此搜索一个字符时只要搜索它的字节编码序列即可，不用担心前后的上下文会对搜索结果产生干扰。</li><li>同时UTF8编码的顺序和Unicode码点的顺序一致，因此可以直接排序UTF8编码序列。</li><li>因为没有嵌入的NUL(0)字节，可以很好地兼容那些使用NUL作为字符串结尾的编程语言。</li></ul><p>Go语言的源文件采用UTF8编码，并且Go语言处理UTF8编码的文本也很出色。</p><ul><li>unicode包提供了诸多处理rune字符相关功能的函数（比如区分字母和数字，或者是字母的大写和小写转换等）</li><li>unicode/utf8包则提供了用于rune字符序列的UTF8编码和解码的功能。</li></ul><p>有很多Unicode字符很难直接从键盘输入，并且还有很多字符有着相似的结构；有一些甚至是不可见的字符。**Go语言字符串面值中的Unicode转义字符让我们可以通过Unicode码点输入特殊的字符。**有两种形式：</p><ul><li><code>\\uhhhh</code>对应16bit的码点值，<code>\\Uhhhhhhhh</code>对应32bit的码点值，其中h是一个十六进制数字；</li><li>一般很少需要使用32bit的形式。每一个对应码点的UTF8编码。例如：下面的字母串面值都表示相同的值：</li></ul><pre><code>&quot;世界&quot;
&quot;\\xe4\\xb8\\x96\\xe7\\x95\\x8c&quot;
&quot;\\u4e16\\u754c&quot;
&quot;\\U00004e16\\U0000754c&quot;
</code></pre><p>上面三个转义序列都为第一个字符串提供替代写法，但是它们的值都是相同的。</p><figure><img src="`+y+`" alt="image-20240416143310476" tabindex="0" loading="lazy"><figcaption>image-20240416143310476</figcaption></figure><p>Unicode转义也可以使用在rune字符中。下面三个字符是等价的：</p><pre><code>&#39;世&#39; &#39;\\u4e16&#39; &#39;\\U00004e16&#39;
</code></pre><figure><img src="`+h+'" alt="image-20240416144001322" tabindex="0" loading="lazy"><figcaption>image-20240416144001322</figcaption></figure><p>对于小于256的码点值可以写在一个十六进制转义字节中，例如<code>\\x41</code>对应字符&#39;A&#39;，但是对于更大的码点则必须使用<code>\\u</code>或<code>\\U</code>转义形式。因此，<code>\\xe4\\xb8\\x96</code>并不是一个合法的rune字符，虽然这三个字节对应一个有效的UTF8编码的码点。</p><figure><img src="'+x+`" alt="image-20240416144219458" tabindex="0" loading="lazy"><figcaption>image-20240416144219458</figcaption></figure><p>我们可以不用解码直接测试一个字符串是否是另一个字符串的前缀：</p><pre><code class="language-Go">func HasPrefix(s, prefix string) bool {
    return len(s) &gt;= len(prefix) &amp;&amp; s[:len(prefix)] == prefix
}
</code></pre><p>或者是后缀测试：</p><pre><code class="language-Go">func HasSuffix(s, suffix string) bool {
    return len(s) &gt;= len(suffix) &amp;&amp; s[len(s)-len(suffix):] == suffix
}
</code></pre><p>或者是包含子串测试：</p><pre><code class="language-Go">func Contains(s, substr string) bool {
    for i := 0; i &lt; len(s); i++ {
...
</code></pre><p>对于UTF8编码后文本的处理和原始的字节处理逻辑是一样的。但是对应很多其它编码则并不是这样的。（上面的函数都来自strings字符串处理包，真实的代码包含了一个用哈希技术优化的Contains 实现。）</p><figure><img src="`+q+`" alt="image-20240416144615253" tabindex="0" loading="lazy"><figcaption>image-20240416144615253</figcaption></figure><p>另一方面，如果我们真的关心每个Unicode字符，我们可以使用其它处理方式。考虑前面的第一个例子中的字符串，它混合了中西两种字符。图3.5展示了它的内存表示形式。字符串包含13个字节，以UTF8形式编码，但是只对应9个Unicode字符：</p><pre><code class="language-Go">import &quot;unicode/utf8&quot;

s := &quot;Hello, 世界&quot;
fmt.Println(len(s))                    // &quot;13&quot;
fmt.Println(utf8.RuneCountInString(s)) // &quot;9&quot;
</code></pre><p>为了处理这些真实的字符，我们需要一个UTF8解码器。unicode/utf8包提供了该功能，我们可以这样使用：</p><pre><code class="language-Go">for i := 0; i &lt; len(s); {
    r, size := utf8.DecodeRuneInString(s[i:])
    fmt.Printf(&quot;%d\\t%c\\n&quot;, i, r)
    i += size
}
</code></pre><p>每一次调用<code>DecodeRuneInString</code>函数都返回一个<code>r</code>和长度，<code>r</code>对应字符本身，长度对应<code>r</code>采用UTF8编码后的编码字节数目。长度可以用于更新第i个字符在字符串中的字节索引位置。</p><p>Go语言的range循环在处理字符串的时候，会自动隐式解码UTF8字符串。(需要注意的是对于非ASCII，索引更新的步长将超过1个字节。)</p><figure><img src="`+w+`" alt="img" tabindex="0" loading="lazy"><figcaption>img</figcaption></figure><pre><code class="language-go"><span class="token keyword">func</span> <span class="token function">unicode</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
...
<span class="token punctuation">}</span>
</code></pre><p>每一个UTF8字符解码，不管是显式地调用<code>utf8.DecodeRuneInString</code>解码或是在<code>range</code>循环中隐式地解码，如果遇到一个错误的UTF8编码输入，将生成一个特别的Unicode字符<code>\\uFFFD</code>，在印刷中这个符号通常是一个黑色六角或钻石形状，里面包含一个白色的问号&quot;?&quot;。</p><p>UTF8字符串作为交换格式是非常方便的，但是在程序内部采用rune序列可能更方便，因为rune大小一致，支持数组索引和方便切割。</p><p>将[]rune类型转换应用到UTF8编码的字符串，将返回字符串编码的Unicode码点序列：</p><pre><code class="language-Go">// &quot;program&quot; in Japanese katakana
s := &quot;プログラム&quot;
fmt.Printf(&quot;% x\\n&quot;, s) // &quot;e3 83 97 e3 83 ad e3 82 b0 e3 83 a9 e3 83 a0&quot;
r := []rune(s)
fmt.Printf(&quot;%x\\n&quot;, r)  // &quot;[30d7 30ed 30b0 30e9 30e0]&quot;
</code></pre><p>（在第一个Printf中的<code>% x</code>参数用于在每个十六进制数字前插入一个空格。）</p><p>如果是将一个[]rune类型的Unicode字符slice或数组转为string，则对它们进行UTF8编码：</p><pre><code class="language-Go">fmt.Println(string(r)) // &quot;プログラム&quot;
</code></pre><p>将一个整数转型为字符串意思是生成以只包含对应Unicode码点字符的UTF8字符串：</p><pre><code class="language-Go">fmt.Println(string(65))     // &quot;A&quot;, not &quot;65&quot;
fmt.Println(string(0x4eac)) // &quot;京&quot;
</code></pre><p>如果对应码点的字符是无效的，则用<code>\\uFFFD</code>无效字符作为替换：</p><pre><code class="language-Go">fmt.Println(string(1234567)) // &quot;?&quot;
</code></pre><figure><img src="`+v+`" alt="image-20240416152614804" tabindex="0" loading="lazy"><figcaption>image-20240416152614804</figcaption></figure><h3 id="_3-5-4-字符串和byte切片" tabindex="-1"><a class="header-anchor" href="#_3-5-4-字符串和byte切片"><span>3.5.4. 字符串和Byte切片</span></a></h3><p>标准库中有四个包对字符串处理尤为重要：bytes、strings、strconv和unicode包。</p><ul><li><p>strings包提供了许多如字符串的查询、替换、比较、截断、拆分和合并等功能。例如ToUpper和ToLower，将原始字符串的每个字符都做相应的转换，然后返回新的字符串。</p></li><li><p>bytes包也提供了很多类似功能的函数，但是针对和字符串有着相同结构的[]byte类型。因为字符串是只读的，因此逐步构建字符串会导致很多分配和复制。在这种情况下，使用bytes.Buffer类型将会更有效，稍后我们将展示。</p></li><li><p>strconv包提供了布尔型、整型数、浮点数和对应字符串的相互转换，还提供了双引号转义相关的转换。</p></li><li><p>unicode包提供了IsDigit、IsLetter、IsUpper和IsLower等类似功能，它们用于给字符分类。每个函数有一个单一的rune类型的参数，然后返回一个布尔值。而像ToUpper和ToLower之类的转换函数将用于rune字符的大小写转换。所有的这些函数都是遵循Unicode标准定义的字母、数字等分类规范。</p></li></ul><p>下面例子的basename函数灵感源于Unix shell的同名工具。在我们实现的版本中，basename(s)将看起来像是系统路径的前缀删除，同时将看似文件类型的后缀名部分删除：</p><pre><code class="language-Go">// basename removes directory components and a .suffix.
...
</code></pre><p><strong>例2</strong></p><p>将一个表示整数值的字符串，每隔三个字符插入一个逗号分隔符，例如“12345”处理后成为“12,345”。这个版本只适用于整数类型；支持浮点数类型的留作练习。</p><pre><code class="language-Go">package main
...
</code></pre><h4 id="byte切片" tabindex="-1"><a class="header-anchor" href="#byte切片"><span>byte切片</span></a></h4><p>一个字符串是包含只读字节的数组，一旦创建，是不可变的。一个字节slice的元素则可以自由地修改。字符串和字节slice之间可以相互转换：</p><pre><code class="language-Go">s := &quot;abc&quot;
b := []byte(s)
s2 := string(b)
</code></pre><p>从概念上讲，一个[]byte(s)转换是分配了一个新的字节数组用于保存字符串数据的拷贝，然后引用这个底层的字节数组。将一个字节slice转换到字符串的string(b)操作则是构造一个字符串拷贝，以确保s2字符串是只读的。</p><p>为了避免转换中不必要的内存分配，bytes包和strings同时提供了许多实用函数。下面是strings包中的六个函数：</p><pre><code class="language-Go">func Contains(s, substr string) bool
func Count(s, sep string) int
func Fields(s string) []string
func HasPrefix(s, prefix string) bool
func Index(s, sep string) int
func Join(a []string, sep string) string
</code></pre><p>bytes包中也对应的六个函数：</p><pre><code class="language-Go">func Contains(b, subslice []byte) bool
func Count(s, sep []byte) int
func Fields(s []byte) [][]byte
func HasPrefix(s, prefix []byte) bool
func Index(s, sep []byte) int
func Join(s [][]byte, sep []byte) []byte
</code></pre><p>它们之间唯一的区别是字符串类型参数被替换成了字节slice类型的参数。</p><p>bytes包还提供了<strong>Buffer类型</strong>用于字节slice的缓存。一个Buffer开始是空的，但是随着string、byte或[]byte等类型数据的写入可以<strong>动态增长</strong>，<strong>一个bytes.Buffer变量并不需要初始化，因为零值也是有效的：</strong></p><pre><code class="language-Go">// intsToString is like fmt.Sprint(values) but adds commas.
...
</code></pre><p>当向<code>bytes.Buffer</code>添加任意字符的UTF8编码时，最好使用<code>bytes.Buffer</code>的<code>WriteRune</code>方法，但是<code>WriteByte</code>方法对于写入类似<code>&#39;[&#39;</code>和<code>&#39;]&#39;</code>等ASCII字符则会更加有效。</p><h3 id="练习-3-10" tabindex="-1"><a class="header-anchor" href="#练习-3-10"><span>练习 3.10</span></a></h3><p>编写一个非递归版本的comma函数，使用bytes.Buffer代替字符串链接操作。</p><pre><code class="language-go"><span class="token keyword">package</span> main
...
</code></pre><h3 id="练习-3-11" tabindex="-1"><a class="header-anchor" href="#练习-3-11"><span>练习 3.11</span></a></h3><p>完善comma函数，以支持浮点数处理和一个可选的正负号的处理。</p><pre><code class="language-go"><span class="token keyword">package</span> main
...
</code></pre><h3 id="练习-3-12" tabindex="-1"><a class="header-anchor" href="#练习-3-12"><span>练习 3.12</span></a></h3><p>编写一个函数，判断两个字符串是否是相互打乱的，也就是说它们有着相同的字符，但是对应不同的顺序。</p><p>这里有一个函数<code>reflect.DeepEqual(m1, m2)</code></p><pre><code class="language-go"><span class="token keyword">package</span> main
...
</code></pre>`,278)]))}const P=s(G,[["render",R],["__file","ch3.html.vue"]]),I=JSON.parse('{"path":"/develop/Go/gopl/ch3.html","title":"03. 基础数据类型","lang":"zh-CN","frontmatter":{"category":"Go","tag":"Go","description":"03. 基础数据类型 Go语言将数据类型分为四类：基础类型、复合类型、引用类型和接口类型。 本章介绍基础类型，包括：数字、字符串和布尔型。 复合数据类型——数组（§4.1）和结构体（§4.2）——是通过组合简单类型，来表达更加复杂的数据结构。 引用类型包括指针（§2.3.2）、切片（§4.2)）、字典（§4.3）、函数（§5）、通道（§8） 将在第7章...","head":[["meta",{"property":"og:url","content":"https://echo0d.github.io/DailyNotes/develop/Go/gopl/ch3.html"}],["meta",{"property":"og:site_name","content":"echo0d-notes"}],["meta",{"property":"og:title","content":"03. 基础数据类型"}],["meta",{"property":"og:description","content":"03. 基础数据类型 Go语言将数据类型分为四类：基础类型、复合类型、引用类型和接口类型。 本章介绍基础类型，包括：数字、字符串和布尔型。 复合数据类型——数组（§4.1）和结构体（§4.2）——是通过组合简单类型，来表达更加复杂的数据结构。 引用类型包括指针（§2.3.2）、切片（§4.2)）、字典（§4.3）、函数（§5）、通道（§8） 将在第7章..."}],["meta",{"property":"og:type","content":"article"}],["meta",{"property":"og:locale","content":"zh-CN"}],["meta",{"property":"og:updated_time","content":"2025-01-10T05:36:24.000Z"}],["meta",{"property":"article:author","content":"echo0d"}],["meta",{"property":"article:tag","content":"Go"}],["meta",{"property":"article:modified_time","content":"2025-01-10T05:36:24.000Z"}],["script",{"type":"application/ld+json"},"{\\"@context\\":\\"https://schema.org\\",\\"@type\\":\\"Article\\",\\"headline\\":\\"03. 基础数据类型\\",\\"image\\":[\\"\\"],\\"dateModified\\":\\"2025-01-10T05:36:24.000Z\\",\\"author\\":[{\\"@type\\":\\"Person\\",\\"name\\":\\"echo0d\\",\\"url\\":\\"\\"}]}"]]},"headers":[{"level":2,"title":"3.1. 整型","slug":"_3-1-整型","link":"#_3-1-整型","children":[{"level":3,"title":"不同的整型&值域","slug":"不同的整型-值域","link":"#不同的整型-值域","children":[]},{"level":3,"title":"二元运算符","slug":"二元运算符","link":"#二元运算符","children":[]},{"level":3,"title":"其他运算符","slug":"其他运算符","link":"#其他运算符","children":[]},{"level":3,"title":"无符号&有符号","slug":"无符号-有符号","link":"#无符号-有符号","children":[]},{"level":3,"title":"数值类型转换","slug":"数值类型转换","link":"#数值类型转换","children":[]},{"level":3,"title":"格式化输出整型","slug":"格式化输出整型","link":"#格式化输出整型","children":[]}]},{"level":2,"title":"3.2. 浮点数","slug":"_3-2-浮点数","link":"#_3-2-浮点数","children":[{"level":3,"title":"浮点数精度","slug":"浮点数精度","link":"#浮点数精度","children":[]},{"level":3,"title":"浮点数特殊值","slug":"浮点数特殊值","link":"#浮点数特殊值","children":[]},{"level":3,"title":"练习 3.1","slug":"练习-3-1","link":"#练习-3-1","children":[]},{"level":3,"title":"练习 3.2","slug":"练习-3-2","link":"#练习-3-2","children":[]},{"level":3,"title":"练习 3.3","slug":"练习-3-3","link":"#练习-3-3","children":[]},{"level":3,"title":"练习 3.4","slug":"练习-3-4","link":"#练习-3-4","children":[]}]},{"level":2,"title":"3.3. 复数","slug":"_3-3-复数","link":"#_3-3-复数","children":[{"level":3,"title":"复数表达式","slug":"复数表达式","link":"#复数表达式","children":[]},{"level":3,"title":"math/cmplx包","slug":"math-cmplx包","link":"#math-cmplx包","children":[]},{"level":3,"title":"练习 3.5","slug":"练习-3-5","link":"#练习-3-5","children":[]},{"level":3,"title":"练习 3.6","slug":"练习-3-6","link":"#练习-3-6","children":[]},{"level":3,"title":"练习 3.7","slug":"练习-3-7","link":"#练习-3-7","children":[]},{"level":3,"title":"练习 3.8","slug":"练习-3-8","link":"#练习-3-8","children":[]},{"level":3,"title":"练习 3.9","slug":"练习-3-9","link":"#练习-3-9","children":[]}]},{"level":2,"title":"3.4. 布尔型","slug":"_3-4-布尔型","link":"#_3-4-布尔型","children":[]},{"level":2,"title":"3.5. 字符串","slug":"_3-5-字符串","link":"#_3-5-字符串","children":[{"level":3,"title":"3.5.1. 字符串面值","slug":"_3-5-1-字符串面值","link":"#_3-5-1-字符串面值","children":[]},{"level":3,"title":"3.5.2. Unicode","slug":"_3-5-2-unicode","link":"#_3-5-2-unicode","children":[]},{"level":3,"title":"3.5.3. UTF-8","slug":"_3-5-3-utf-8","link":"#_3-5-3-utf-8","children":[]},{"level":3,"title":"3.5.4. 字符串和Byte切片","slug":"_3-5-4-字符串和byte切片","link":"#_3-5-4-字符串和byte切片","children":[]},{"level":3,"title":"练习 3.10","slug":"练习-3-10","link":"#练习-3-10","children":[]},{"level":3,"title":"练习 3.11","slug":"练习-3-11","link":"#练习-3-11","children":[]},{"level":3,"title":"练习 3.12","slug":"练习-3-12","link":"#练习-3-12","children":[]}]}],"git":{"createdTime":1722415943000,"updatedTime":1736487384000,"contributors":[{"name":"echo0d","email":"echo0d@163.com","commits":2}]},"readingTime":{"minutes":45.08,"words":13525},"filePathRelative":"develop/Go/gopl/ch3.md","localizedDate":"2024年7月31日","excerpt":"\\n<p>Go语言将数据类型分为四类：基础类型、复合类型、引用类型和接口类型。</p>\\n<ul>\\n<li>本章介绍基础类型，包括：数字、字符串和布尔型。</li>\\n<li>复合数据类型——数组（§4.1）和结构体（§4.2）——是通过组合简单类型，来表达更加复杂的数据结构。</li>\\n<li>引用类型包括指针（§2.3.2）、切片（§4.2)）、字典（§4.3）、函数（§5）、通道（§8）</li>\\n<li>将在第7章介绍接口类型</li>\\n</ul>\\n<p>虽然数据种类很多，但它们都是对程序中一个变量或状态的间接引用。这意味着对任一引用类型数据的修改都会影响所有该引用的拷贝。</p>\\n<p>Go语言的数值类型包括几种不同大小的整数、浮点数和复数。每种数值类型都决定了对应的大小范围和是否支持正负符号。</p>","autoDesc":true}');export{P as comp,I as data};
