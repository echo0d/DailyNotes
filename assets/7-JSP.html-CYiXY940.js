import{_ as s}from"./plugin-vue_export-helper-DlAUqK2U.js";import{c as a,a as t,o as e}from"./app-CQsA8Yx3.js";const p="/DailyNotes/assets/image-20240813172037246-DZa0BJlN.png",o="/DailyNotes/assets/image-20240813172146967-CtPW01CJ.png",c="/DailyNotes/assets/image-20240813172712144-FNtRrAIg.png",l={};function u(i,n){return e(),a("div",null,n[0]||(n[0]=[t(`<h1 id="_7-javaweb审计基础-jsp" tabindex="-1"><a class="header-anchor" href="#_7-javaweb审计基础-jsp"><span>7-JavaWeb审计基础-JSP</span></a></h1><h2 id="_1-jsp" tabindex="-1"><a class="header-anchor" href="#_1-jsp"><span>1. JSP</span></a></h2><p>JSP（全称：Java Server Pages）：Java 服务端页面。是一种动态的网页技术，其中既可以定义 HTML、JS、CSS等静态内容，还可以定义 Java代码的动态内容，也就是 <code>JSP = HTML + Java</code>。如下就是jsp代码</p><pre><code class="language-plaintext"> &lt;html&gt;
     &lt;head&gt;
         &lt;title&gt;Title&lt;/title&gt;
     &lt;/head&gt;
     &lt;body&gt;
...
<span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">ServletDemo1</span> <span class="token keyword">extends</span> <span class="token class-name">HttpServlet</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre></li><li><p>在 <code>el-demo.jsp</code> 中通过 EL表达式 获取数据</p><pre><code class="language-jsp">&lt;%@ page contentType=&quot;text/html;charset=UTF-8&quot; language=&quot;java&quot; %&gt;
&lt;html&gt;
&lt;head&gt;
    &lt;title&gt;Title&lt;/title&gt;
&lt;/head&gt;
...
&lt;/body&gt;
&lt;/html&gt;
</code></pre></li><li><p>在浏览器的地址栏输入 <code>demo1</code>这个servlet ，页面效果如下：</p><figure><img src="`+c+`" alt="image-20240813172712144" tabindex="0" loading="lazy"><figcaption>image-20240813172712144</figcaption></figure></li></ul><h3 id="域对象" tabindex="-1"><a class="header-anchor" href="#域对象"><span>域对象</span></a></h3><p>JavaWeb中有四大域对象，分别是：</p><ul><li><p>page：</p><p>有效范围pageContext：只在一个页面中保存属性，跳转后无效</p><p>作用：代表jsp中</p></li><li><p>request：</p><p>作用：提供对请求数据的访问，提供用于加入特定请求数据访问</p><p>有效范围：只在当前请求中保存，服务器跳转有效，客户端跳转无效</p><p>主要用于处理用户的提交信息</p></li><li><p>session：</p><p>作用：用于保存客户端与服务端之间的数据</p><p>有效范围：在一次会话中有效，无论何种跳转都有效。</p></li><li><p>application：</p><p>有效范围：整个项目，项目关闭、重启数据会丢失，如果项目不关闭，所有用户访问该项目的所有页面都可以获取application</p></li></ul><h2 id="_3-jstl标签" tabindex="-1"><a class="header-anchor" href="#_3-jstl标签"><span>3. JSTL标签</span></a></h2><p>JSP标准标签库(Jsp Standarded Tag Library) ，使用标签取代JSP页面上的Java代码。如下代码就是JSTL标签</p><pre><code class="language-jsp">&lt;c:if test=&quot;\${flag == 1}&quot;&gt;
    男
&lt;/c:if&gt;
&lt;c:if test=&quot;\${flag == 2}&quot;&gt;
    女
...
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>dependency</span><span class="token punctuation">&gt;</span></span>
</code></pre></li><li><p>在JSP页面上引入JSTL标签库</p><pre><code class="language-jsp">&lt;%@ taglib prefix=&quot;c&quot; uri=&quot;http://java.sun.com/jsp/jstl/core&quot; %&gt; 
...
&lt;/body&gt;
&lt;/html&gt;
</code></pre></li></ul><h3 id="foreach-标签" tabindex="-1"><a class="header-anchor" href="#foreach-标签"><span>forEach 标签</span></a></h3><p><code>&lt;c:forEach&gt;</code>：相当于 for 循环。java中有增强for循环和普通for循环，JSTL 中的 <code>&lt;c:forEach&gt;</code> 也有两种用法</p><p><strong>用法一</strong></p><p>类似于 Java 中的增强for循环。涉及到的 <code>&lt;c:forEach&gt;</code> 中的属性如下</p><ul><li>items：被遍历的容器</li><li>var：遍历产生的临时变量</li><li>varStatus：遍历状态对象</li></ul><p>如下代码，是从域对象中获取名为 brands 数据，该数据是一个集合；遍历遍历，并给该集合中的每一个元素起名为 <code>brand</code>，是 Brand对象。在循环里面使用 EL表达式获取每一个Brand对象的属性值</p><pre><code class="language-jsp">&lt;c:forEach items=&quot;\${Users}&quot; var=&quot;User&quot;&gt;
    &lt;tr&quot;&gt;
        &lt;td&gt;\${User.userName}&lt;/td&gt;
        &lt;td&gt;\${brand.sex}&lt;/td&gt;
...
&lt;/body&gt;
&lt;/html&gt;
</code></pre></li></ul><p>效果：</p><p><strong>用法二</strong></p><p>类似于 Java 中的普通for循环。涉及到的 <code>&lt;c:forEach&gt;</code> 中的属性如下</p><ul><li>begin：开始数</li><li>end：结束数</li><li>step：步长</li></ul><p>实例代码：</p><p>从0循环到10，变量名是 <code>i</code> ，每次自增1</p><pre><code class="language-jsp">&lt;c:forEach begin=&quot;0&quot; end=&quot;10&quot; step=&quot;1&quot; var=&quot;i&quot;&gt;
    \${i}
&lt;/c:forEach&gt;
</code></pre><p>效果：</p>`,55)]))}const d=s(l,[["render",u]]),g=JSON.parse('{"path":"/CodeAudittutorial/2-JavaWeb/7-JSP.html","title":"7-JavaWeb审计基础-JSP","lang":"zh-CN","frontmatter":{"category":"代码审计","tag":"Java","description":"7-JavaWeb审计基础-JSP 1. JSP JSP（全称：Java Server Pages）：Java 服务端页面。是一种动态的网页技术，其中既可以定义 HTML、JS、CSS等静态内容，还可以定义 Java代码的动态内容，也就是 JSP = HTML + Java。如下就是jsp代码 JSP 就是一个页面本质上就是一个 Servlet JSP...","head":[["meta",{"property":"og:url","content":"https://echo0d.github.io/DailyNotes/CodeAudittutorial/2-JavaWeb/7-JSP.html"}],["meta",{"property":"og:site_name","content":"echo0d-notes"}],["meta",{"property":"og:title","content":"7-JavaWeb审计基础-JSP"}],["meta",{"property":"og:description","content":"7-JavaWeb审计基础-JSP 1. JSP JSP（全称：Java Server Pages）：Java 服务端页面。是一种动态的网页技术，其中既可以定义 HTML、JS、CSS等静态内容，还可以定义 Java代码的动态内容，也就是 JSP = HTML + Java。如下就是jsp代码 JSP 就是一个页面本质上就是一个 Servlet JSP..."}],["meta",{"property":"og:type","content":"article"}],["meta",{"property":"og:locale","content":"zh-CN"}],["meta",{"property":"og:updated_time","content":"2025-04-11T02:11:10.000Z"}],["meta",{"property":"article:author","content":"echo0d"}],["meta",{"property":"article:tag","content":"Java"}],["meta",{"property":"article:modified_time","content":"2025-04-11T02:11:10.000Z"}],["script",{"type":"application/ld+json"},"{\\"@context\\":\\"https://schema.org\\",\\"@type\\":\\"Article\\",\\"headline\\":\\"7-JavaWeb审计基础-JSP\\",\\"image\\":[\\"\\"],\\"dateModified\\":\\"2025-04-11T02:11:10.000Z\\",\\"author\\":[{\\"@type\\":\\"Person\\",\\"name\\":\\"echo0d\\",\\"url\\":\\"\\"}]}"]]},"headers":[{"level":2,"title":"1. JSP","slug":"_1-jsp","link":"#_1-jsp","children":[{"level":3,"title":"JSP访问流程","slug":"jsp访问流程","link":"#jsp访问流程","children":[]}]},{"level":2,"title":"2. EL 表达式","slug":"_2-el-表达式","link":"#_2-el-表达式","children":[{"level":3,"title":"代码演示","slug":"代码演示","link":"#代码演示","children":[]},{"level":3,"title":"域对象","slug":"域对象","link":"#域对象","children":[]}]},{"level":2,"title":"3. JSTL标签","slug":"_3-jstl标签","link":"#_3-jstl标签","children":[{"level":3,"title":"JSTL 使用流程","slug":"jstl-使用流程","link":"#jstl-使用流程","children":[]},{"level":3,"title":"if 标签","slug":"if-标签","link":"#if-标签","children":[]},{"level":3,"title":"forEach 标签","slug":"foreach-标签","link":"#foreach-标签","children":[]}]}],"git":{"createdTime":1703388937000,"updatedTime":1744337470000,"contributors":[{"name":"echo0d","email":"echo0d@163.com","commits":5}]},"readingTime":{"minutes":6.38,"words":1914},"filePathRelative":"CodeAudittutorial/2-JavaWeb/7-JSP.md","localizedDate":"2023年12月24日","excerpt":"\\n<h2>1. JSP</h2>\\n<p>JSP（全称：Java Server Pages）：Java 服务端页面。是一种动态的网页技术，其中既可以定义 HTML、JS、CSS等静态内容，还可以定义 Java代码的动态内容，也就是 <code>JSP = HTML + Java</code>。如下就是jsp代码</p>\\n<pre><code class=\\"language-plaintext\\"> &lt;html&gt;\\n     &lt;head&gt;\\n         &lt;title&gt;Title&lt;/title&gt;\\n     &lt;/head&gt;\\n     &lt;body&gt;\\n         &lt;h1&gt;JSP,Hello World&lt;/h1&gt;\\n         &lt;%\\n             System.out.println(\\"hello,jsp~\\");\\n         %&gt;\\n     &lt;/body&gt;\\n &lt;/html&gt;\\n</code></pre>","autoDesc":true}');export{d as comp,g as data};
