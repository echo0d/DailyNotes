...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>函数<code>reflect.TypeOf</code> 接受任意的 <code>interface{} </code>类型，并以<code>reflect.Type</code>形式返回其动态类型：</p><div class="language-Go line-numbers-mode" data-ext="Go"><pre class="language-Go"><code>t := reflect.TypeOf(3)  // a reflect.Type
