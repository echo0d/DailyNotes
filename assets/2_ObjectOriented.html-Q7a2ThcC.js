import{_ as e}from"./plugin-vue_export-helper-DlAUqK2U.js";import{c as o,a as p,b as a,d as s,e as c,r as l,o as u}from"./app-C_hhttlP.js";const k="/DailyNotes/assets/java-extends-2020-12-08-BIVGUYKS.png",i="/DailyNotes/assets/overloading-vs-overriding-B5QNp5Fr.png",r="/DailyNotes/assets/20171102-1-DaktwDbn.png",d="/DailyNotes/assets/2DAC601E-70D8-4B3C-86CC-7E4972FC2466-DS6zi3E8.jpg",m="/DailyNotes/assets/good-jar-DezWtmZj.jpg",y="/DailyNotes/assets/bad-jar-DFqFnxF5.jpg",g={},w={href:"https://liaoxuefeng.com/books/java/oop/maven/index.html",target:"_blank",rel:"noopener noreferrer"};function h(v,n){const t=l("ExternalLinkIcon");return u(),o("div",null,[n[5]||(n[5]=p(`<h1 id="_2-java面向对象" tabindex="-1"><a class="header-anchor" href="#_2-java面向对象"><span>2-Java面向对象</span></a></h1><h2 id="继承" tabindex="-1"><a class="header-anchor" href="#继承"><span>继承</span></a></h2><p>在Java中，继承是一种面向对象编程的重要概念，它允许一个类（子类）获取另一个类（父类）的属性和方法。这种机制使代码重用变得更加容易，同时也有助于建立类之间的层次结构。以下是关于Java继承的一些详细介绍：</p><h3 id="类的继承格式" tabindex="-1"><a class="header-anchor" href="#类的继承格式"><span>类的继承格式</span></a></h3><p>在 Java 中通过 extends 关键字可以申明一个类是从另外一个类继承而来的，一般形式如下：</p><pre><code class="language-java"><span class="token keyword">class</span> 父类 <span class="token punctuation">{</span>
