import{_ as e}from"./plugin-vue_export-helper-DlAUqK2U.js";import{c,f as t,a as s,e as a,b as o,o as l,r as u}from"./app-BoR_3jx9.js";const i={},k={href:"https://link.segmentfault.com/?enc=eaZYMU7AZnrFASQuCCXHvw%3D%3D.x84T7b%2Fj6aCr1W1EestSDb5Y9EQGndvqWbhoIl8DADE%3D",target:"_blank",rel:"noopener noreferrer"},r={href:"https://link.segmentfault.com/?enc=wGjhpbdtDzGcnObVZRlTOw%3D%3D.nyyE44PVOuqeGs%2FHlUso2cD0p4S867dRCs84HrmIfZ6uppGQqNvy%2FK%2Fq%2FahgI45T",target:"_blank",rel:"noopener noreferrer"},d={href:"https://hacks.mozilla.org/2018/03/es-modules-a-cartoon-deep-dive/",target:"_blank",rel:"noopener noreferrer"};function m(g,n){const p=u("ExternalLinkIcon");return l(),c("div",null,[n[9]||(n[9]=t(`<h1 id="前端模块化" tabindex="-1"><a class="header-anchor" href="#前端模块化"><span>前端模块化</span></a></h1><h2 id="_1-模块化的理解" tabindex="-1"><a class="header-anchor" href="#_1-模块化的理解"><span>1. 模块化的理解</span></a></h2><h3 id="_1-1-什么是模块化" tabindex="-1"><a class="header-anchor" href="#_1-1-什么是模块化"><span>1.1. 什么是模块化</span></a></h3><ul><li>将一个复杂的程序依据一定的规则(规范)封装成几个块(文件), 并进行组合在一起</li><li>块的内部数据与实现是私有的, 只是向外部暴露一些接口(方法)与外部其它模块通信</li><li>模块化开发的好处 <ul><li>避免命名冲突</li><li>更好地分离, 降低了耦合</li><li>提高代码的复用性</li><li>提高代码的可维护性</li></ul></li></ul><h3 id="_1-2-模块化的演进" tabindex="-1"><a class="header-anchor" href="#_1-2-模块化的演进"><span>1.2. 模块化的演进</span></a></h3><ul><li><p>全局函数模式</p><ul><li>将不同的功能封装成不同的全局函数</li><li>问题: 污染全局命名空间, 容易引起命名冲突，而且模块成员之间看不出直接关系</li></ul></li></ul><pre><code class="language-js"><span class="token keyword">function</span> <span class="token function">m1</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
