import{_ as s}from"./plugin-vue_export-helper-DlAUqK2U.js";import{c as a,b as p,o as t}from"./app-C5cR4qpO.js";const o={};function e(c,n){return t(),a("div",null,n[0]||(n[0]=[p(`<h1 id="_1-基础收尾" tabindex="-1"><a class="header-anchor" href="#_1-基础收尾"><span>1. 基础收尾</span></a></h1><h2 id="_1-1-项目结构" tabindex="-1"><a class="header-anchor" href="#_1-1-项目结构"><span>1.1. 项目结构</span></a></h2><p>在 Go 语言中，经典的项目结构通常遵循一种约定俗成的布局，这有助于使项目更具可读性和易维护性。以下是一个经典的 Go 项目结构示例：</p><pre><code>project-root/
|-- cmd/
|   |-- main.go
|
|-- internal/
