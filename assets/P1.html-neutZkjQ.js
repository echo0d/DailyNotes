import{_ as n}from"./plugin-vue_export-helper-x3n3nnut.js";import{o as s,c as a,e}from"./app-IVoIJv3M.js";const i={},t=e(`<h1 id="_1-基础收尾" tabindex="-1"><a class="header-anchor" href="#_1-基础收尾" aria-hidden="true">#</a> 1. 基础收尾</h1><h2 id="_1-1-项目结构" tabindex="-1"><a class="header-anchor" href="#_1-1-项目结构" aria-hidden="true">#</a> 1.1. 项目结构</h2><p>在 Go 语言中，经典的项目结构通常遵循一种约定俗成的布局，这有助于使项目更具可读性和易维护性。以下是一个经典的 Go 项目结构示例：</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>project-root/
|-- cmd/
|   |-- main.go
|
|-- internal/
