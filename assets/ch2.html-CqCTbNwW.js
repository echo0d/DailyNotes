...
</code></pre><figure><img src="`+i+`" alt="image-20240323175325426" tabindex="0" loading="lazy"><figcaption>image-20240323175325426</figcaption></figure><p>比较运算符 <code>==</code>和 <code>&lt;</code>也可以用来比较一个命名类型的变量和另一个有相同类型的变量，或有着相同底层类型的未命名类型的值之间做比较。但是如果两个值有着不同的类型，则不能直接进行比较：</p><pre><code class="language-Go">var c Celsius
var f Fahrenheit
