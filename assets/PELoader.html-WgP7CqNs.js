...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>在C++中执行一个<code>.dll</code>文件通常是通过加载动态链接库并调用其中的函数。</p><div class="language-c++ line-numbers-mode" data-ext="c++"><pre class="language-c++"><code>#include &lt;windows.h&gt;
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>(3) 还原.exe的内容</strong></p><div class="language-C# line-numbers-mode" data-ext="C#"><pre class="language-C#"><code>using System;
using System.Reflection;
namespace TestApplication
{
    public class Program
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>(4) 使用Assembly.Load()加载程序集并调用方法</strong></p><p>代码如下：</p><div class="language-C# line-numbers-mode" data-ext="C#"><pre class="language-C#"><code>using System;
using System.Reflection;
namespace TestApplication
{
    public class Program
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_1-3-示例代码" tabindex="-1"><a class="header-anchor" href="#_1-3-示例代码" aria-hidden="true">#</a> 1.3. 示例代码</h3><h4 id="c" tabindex="-1"><a class="header-anchor" href="#c" aria-hidden="true">#</a> c#</h4><div class="language-C# line-numbers-mode" data-ext="C#"><pre class="language-C#"><code>using System;
using System.IO;
using System.Reflection;
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>执行的C#源码</p><div class="language-C# line-numbers-mode" data-ext="C#"><pre class="language-C#"><code>using System;
...
namespace TEST
{
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_2-4-内存加载执行-net程序集" tabindex="-1"><a class="header-anchor" href="#_2-4-内存加载执行-net程序集" aria-hidden="true">#</a> 2.4. 内存加载执行.NET程序集</h3><p>1.初始化CLR环境(同上)</p><div class="language-c++ line-numbers-mode" data-ext="c++"><pre class="language-c++"><code>	CLRCreateInstance(CLSID_CLRMetaHost, IID_ICLRMetaHost, (VOID**)&amp;iMetaHost);
	...
	iRuntimeHost-&gt;Start();
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>2.通过ICLRRuntimeHost获取AppDomain接口指针，然后通过AppDomain接口的QueryInterface方法来查询默认应用程序域的实例指针。</p><div class="language-c++ line-numbers-mode" data-ext="c++"><pre class="language-c++"><code>	iRuntimeHost-&gt;GetDefaultDomain(&amp;pAppDomain);
	pAppDomain-&gt;QueryInterface(__uuidof(_AppDomain), (VOID**)&amp;pDefaultAppDomain);
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><p>3.通过默认应用程序域实例的Load_3方法加载安全.net程序集数组，并返回Assembly的实例对象指针，通过Assembly实例对象的get_EntryPoint方法获取描述入口点的MethodInfo实例对象。</p><div class="language-c++ line-numbers-mode" data-ext="c++"><pre class="language-c++"><code>	saBound[0].cElements = ASSEMBLY_LENGTH;
	saBound[0].lLbound = 0;
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>4.创建参数安全数组</p><div class="language-c++ line-numbers-mode" data-ext="c++"><pre class="language-c++"><code>ZeroMemory(&amp;vRet, sizeof(VARIANT));
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>5.通过描述入口点的MethodInfo实例对象的Invoke方法执行入口点。</p><div class="language-c++ line-numbers-mode" data-ext="c++"><pre class="language-c++"><code>HRESULT hr = pMethodInfo-&gt;Invoke_3(vObj, args, &amp;vRet);
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h4 id="示例代码-1" tabindex="-1"><a class="header-anchor" href="#示例代码-1" aria-hidden="true">#</a> 示例代码</h4><div class="language-C++ line-numbers-mode" data-ext="C++"><pre class="language-C++"><code>#include &lt;stdio.h&gt;
#include &lt;tchar.h&gt;
#include &lt;metahost.h&gt;
#pragma comment(lib, &quot;mscoree.lib&quot;)
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_3-managed代码内存加载执行pe文件" tabindex="-1"><a class="header-anchor" href="#_3-managed代码内存加载执行pe文件" aria-hidden="true">#</a> 3. managed代码内存加载执行PE文件</h2><p>需要自己实现PE加载器</p><h2 id="_4-unmanaged代码内存加载执行pe文件" tabindex="-1"><a class="header-anchor" href="#_4-unmanaged代码内存加载执行pe文件" aria-hidden="true">#</a> 4. unmanaged代码内存加载执行PE文件</h2><p>需要自己实现PE加载器</p><p>TODO:反射dll注入</p>`,29);function M(T,G){const A=t("ExternalLinkIcon");return l(),c("div",null,[v,n("p",null,[n("a",m,[a("Assembly.Load Method (System.Reflection) | Microsoft Learn"),s(A)])]),b,n("p",null,[n("a",g,[a("ICLRRuntimeHost Interface - .NET Framework | Microsoft Learn"),s(A)])]),k,n("figure",null,[n("a",h,[f,s(A)]),C]),E,n("figure",null,[n("a",y,[I,s(A)]),B]),R,n("figure",null,[n("a",L,[D,s(A)]),_]),n("figure",null,[n("a",S,[w,s(A)]),x]),N])}const q=i(p,[["render",M],["__file","PELoader.html.vue"]]);export{q as default};
